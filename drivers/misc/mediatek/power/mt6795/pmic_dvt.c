...
void read_adc_value(int index)
{
    ...
    //------------------------------------------------------------
    if(index == 0) {
        pr_notice("mt6331_upmu_get_qi_vdvfs11_en=%d\n", mt6331_upmu_get_qi_vdvfs11_en());
        pr_notice("mt6331_upmu_get_ni_vdvfs11_vosel=%d\n", mt6331_upmu_get_ni_vdvfs11_vosel());
    }
    else if(index == 1) {
        pr_notice("mt6331_upmu_get_qi_vdvfs12_en=%d\n", mt6331_upmu_get_qi_vdvfs12_en());
        pr_notice("mt6331_upmu_get_ni_vdvfs12_vosel=%d\n", mt6331_upmu_get_ni_vdvfs12_vosel());
    }
    else if(index == 2) {
        pr_notice("mt6331_upmu_get_qi_vdvfs13_en=%d\n", mt6331_upmu_get_qi_vdvfs13_en());
        pr_notice("mt6331_upmu_get_ni_vdvfs13_vosel=%d\n", mt6331_upmu_get_ni_vdvfs13_vosel());
    }
    else if(index == 3) {
        pr_notice("mt6331_upmu_get_qi_vdvfs14_en=%d\n", mt6331_upmu_get_qi_vdvfs14_en());
        pr_notice("mt6331_upmu_get_ni_vdvfs14_vosel=%d\n", mt6331_upmu_get_ni_vdvfs14_vosel());
    }
    else if(index == 4) {
        pr_notice("mt6331_upmu_get_qi_vgpu_en=%d\n", mt6331_upmu_get_qi_vgpu_en());
        pr_notice("mt6331_upmu_get_ni_vgpu_vosel=%d\n", mt6331_upmu_get_ni_vgpu_vosel());
    }
    else if(index == 5) {
        pr_notice("mt6331_upmu_get_qi_vcore1_en=%d\n", mt6331_upmu_get_qi_vcore1_en());
        pr_notice("mt6331_upmu_get_ni_vcore1_vosel=%d\n", mt6331_upmu_get_ni_vcore1_vosel());
    }
    else if(index == 6) {
        pr_notice("mt6331_upmu_get_qi_vcore2_en=%d\n", mt6331_upmu_get_qi_vcore2_en());
        pr_notice("mt6331_upmu_get_ni_vcore2_vosel=%d\n", mt6331_upmu_get_ni_vcore2_vosel());
    }
    else if(index == 7) {
        pr_notice("mt6331_upmu_get_qi_vio18_en=%d\n", mt6331_upmu_get_qi_vio18_en());
        pr_notice("mt6331_upmu_get_ni_vio18_vosel=%d\n", mt6331_upmu_get_ni_vio18_vosel());
    }
    else if(index == 8) {
        pr_notice("mt6332_upmu_get_qi_vdram_en=%d\n", mt6332_upmu_get_qi_vdram_en());
        pr_notice("mt6332_upmu_get_ni_vdram_vosel=%d\n", mt6332_upmu_get_ni_vdram_vosel());
    }
    else if(index == 9) {
        pr_notice("mt6332_upmu_get_qi_vdvfs2_en=%d\n", mt6332_upmu_get_qi_vdvfs2_en());
        pr_notice("mt6332_upmu_get_ni_vdvfs2_vosel=%d\n", mt6332_upmu_get_ni_vdvfs2_vosel());
    }
    else if(index == 10) {
        pr_notice("mt6332_upmu_get_qi_vrf1_en=%d\n", mt6332_upmu_get_qi_vrf1_en());
        pr_notice("mt6332_upmu_get_ni_vrf1_vosel=%d\n", mt6332_upmu_get_ni_vrf1_vosel());
    }
    else if(index == 11) {
        pr_notice("mt6332_upmu_get_qi_vrf2_en=%d\n", mt6332_upmu_get_qi_vrf2_en());
        pr_notice("mt6332_upmu_get_ni_vrf2_vosel=%d\n", mt6332_upmu_get_ni_vrf2_vosel());
    }
    else if(index == 12) {
        pr_notice("mt6332_upmu_get_qi_vpa_en=%d\n", mt6332_upmu_get_qi_vpa_en());
        pr_notice("mt6332_upmu_get_ni_vpa_vosel=%d\n", mt6332_upmu_get_ni_vpa_vosel());
    }
    else if(index == 13) {
        pr_notice("mt6332_upmu_get_qi_vsbst_en=%d\n", mt6332_upmu_get_qi_vsbst_en());
        pr_notice("mt6332_upmu_get_ni_vsbst_vosel=%d\n", mt6332_upmu_get_ni_vsbst_vosel());
    }
    else if(index == 99) {
...
void set_srclken_2_val(int val)
{
    ...
    pr_notice("[31 SRCLKEN=%d] Reg[0x%x]=0x%x, [bit 1]\n", val, MT6331_TOP_CON, upmu_get_reg_value(MT6331_TOP_CON));
#else // For 32 DVT
    mt6332_upmu_set_rg_srclken_in2_en(val);
    pr_notice("[32 SRCLKEN=%d] Reg[0x%x]=0x%x, [bit 1]\n", val, MT6332_TOP_CON, upmu_get_reg_value(MT6332_TOP_CON));
#endif
}
...
void exec_scrxxx_map(int buck_index)
{
    ...
    pr_notice("[exec_scrxxx_map] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); read_adc_value(buck_index);

    pr_notice("[exec_scrxxx_map] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); read_adc_value(buck_index);

    pr_notice("[exec_scrxxx_map] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); read_adc_value(buck_index);

    pr_notice("[exec_scrxxx_map] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vdvfs11_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vdvfs11_en_ctrl] %d\n", i);
        mt6331_upmu_set_vdvfs11_en_ctrl(i);

        switch(i){
            case 0:
                pr_notice("[mt6331_upmu_set_vdvfs11_en(0)]\n");
                mt6331_upmu_set_vdvfs11_en(0);
                read_adc_value(VDVFS11_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs11_en(1)]\n");
                mt6331_upmu_set_vdvfs11_en(1);
                read_adc_value(VDVFS11_INDEX);
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_vdvfs11_en_sel(0)]\n");
                mt6331_upmu_set_vdvfs11_en_sel(0);
                exec_scrxxx_map(VDVFS11_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs11_en_sel(1)]\n");
                mt6331_upmu_set_vdvfs11_en_sel(1);
                exec_scrxxx_map(VDVFS11_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs11_en_sel(2)]\n");
                mt6331_upmu_set_vdvfs11_en_sel(2);
                exec_scrxxx_map(VDVFS11_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs11_en_sel(3)]\n");
...
void exec_vdvfs12_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vdvfs12_en_ctrl] %d\n", i);
        mt6331_upmu_set_vdvfs12_en_ctrl(i);

        switch(i){
            case 0:
                pr_notice("[mt6331_upmu_set_vdvfs12_en(0)]\n");
                mt6331_upmu_set_vdvfs12_en(0);
                read_adc_value(VDVFS12_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs12_en(1)]\n");
                mt6331_upmu_set_vdvfs12_en(1);
                read_adc_value(VDVFS12_INDEX);
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_vdvfs12_en_sel(0)]\n");
                mt6331_upmu_set_vdvfs12_en_sel(0);
                exec_scrxxx_map(VDVFS12_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs12_en_sel(1)]\n");
                mt6331_upmu_set_vdvfs12_en_sel(1);
                exec_scrxxx_map(VDVFS12_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs12_en_sel(2)]\n");
                mt6331_upmu_set_vdvfs12_en_sel(2);
                exec_scrxxx_map(VDVFS12_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs12_en_sel(3)]\n");
...
void exec_vdvfs13_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vdvfs13_en_ctrl] %d\n", i);
        mt6331_upmu_set_vdvfs13_en_ctrl(i);

        switch(i){
            case 0:
                pr_notice("[mt6331_upmu_set_vdvfs13_en(0)]\n");
                mt6331_upmu_set_vdvfs13_en(0);
                read_adc_value(VDVFS13_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs13_en(1)]\n");
                mt6331_upmu_set_vdvfs13_en(1);
                read_adc_value(VDVFS13_INDEX);
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_vdvfs13_en_sel(0)]\n");
                mt6331_upmu_set_vdvfs13_en_sel(0);
                exec_scrxxx_map(VDVFS13_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs13_en_sel(1)]\n");
                mt6331_upmu_set_vdvfs13_en_sel(1);
                exec_scrxxx_map(VDVFS13_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs13_en_sel(2)]\n");
                mt6331_upmu_set_vdvfs13_en_sel(2);
                exec_scrxxx_map(VDVFS13_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs13_en_sel(3)]\n");
...
void exec_vdvfs14_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vdvfs14_en_ctrl] %d\n", i);
        mt6331_upmu_set_vdvfs14_en_ctrl(i);

        switch(i){
            case 0:
                pr_notice("[mt6331_upmu_set_vdvfs14_en(0)]\n");
                mt6331_upmu_set_vdvfs14_en(0);
                read_adc_value(VDVFS14_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs14_en(1)]\n");
                mt6331_upmu_set_vdvfs14_en(1);
                read_adc_value(VDVFS14_INDEX);
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_vdvfs14_en_sel(0)]\n");
                mt6331_upmu_set_vdvfs14_en_sel(0);
                exec_scrxxx_map(VDVFS14_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs14_en_sel(1)]\n");
                mt6331_upmu_set_vdvfs14_en_sel(1);
                exec_scrxxx_map(VDVFS14_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs14_en_sel(2)]\n");
                mt6331_upmu_set_vdvfs14_en_sel(2);
                exec_scrxxx_map(VDVFS14_INDEX);

                pr_notice("[mt6331_upmu_set_vdvfs14_en_sel(3)]\n");
...
void exec_vgpu_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vgpu_en_ctrl] %d\n", i);
        mt6331_upmu_set_vgpu_en_ctrl(i);

        switch(i){
            case 0:
                pr_notice("[mt6331_upmu_set_vgpu_en(0)]\n");
                mt6331_upmu_set_vgpu_en(0);
                read_adc_value(VGPU_INDEX);

                pr_notice("[mt6331_upmu_set_vgpu_en(1)]\n");
                mt6331_upmu_set_vgpu_en(1);
                read_adc_value(VGPU_INDEX);
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_vgpu_en_sel(0)]\n");
                mt6331_upmu_set_vgpu_en_sel(0);
                exec_scrxxx_map(VGPU_INDEX);

                pr_notice("[mt6331_upmu_set_vgpu_en_sel(1)]\n");
                mt6331_upmu_set_vgpu_en_sel(1);
                exec_scrxxx_map(VGPU_INDEX);

                pr_notice("[mt6331_upmu_set_vgpu_en_sel(2)]\n");
                mt6331_upmu_set_vgpu_en_sel(2);
                exec_scrxxx_map(VGPU_INDEX);

                pr_notice("[mt6331_upmu_set_vgpu_en_sel(3)]\n");
...
void exec_vcore1_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vcore1_en_ctrl] %d\n", i);
        mt6331_upmu_set_vcore1_en_ctrl(i);

        switch(i){
            case 0:
                pr_notice("[mt6331_upmu_set_vcore1_en(0)]\n");
                mt6331_upmu_set_vcore1_en(0);
                read_adc_value(VCORE1_INDEX);

                pr_notice("[mt6331_upmu_set_vcore1_en(1)]\n");
                mt6331_upmu_set_vcore1_en(1);
                read_adc_value(VCORE1_INDEX);
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_vcore1_en_sel(0)]\n");
                mt6331_upmu_set_vcore1_en_sel(0);
                exec_scrxxx_map(VCORE1_INDEX);

                pr_notice("[mt6331_upmu_set_vcore1_en_sel(1)]\n");
                mt6331_upmu_set_vcore1_en_sel(1);
                exec_scrxxx_map(VCORE1_INDEX);

                pr_notice("[mt6331_upmu_set_vcore1_en_sel(2)]\n");
                mt6331_upmu_set_vcore1_en_sel(2);
                exec_scrxxx_map(VCORE1_INDEX);

                pr_notice("[mt6331_upmu_set_vcore1_en_sel(3)]\n");
...
void exec_vcore2_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vcore2_en_ctrl] %d\n", i);
        mt6331_upmu_set_vcore2_en_ctrl(i);

        switch(i){
            case 0:
                pr_notice("[mt6331_upmu_set_vcore2_en(0)]\n");
                mt6331_upmu_set_vcore2_en(0);
                read_adc_value(VCORE2_INDEX);

                pr_notice("[mt6331_upmu_set_vcore2_en(1)]\n");
                mt6331_upmu_set_vcore2_en(1);
                read_adc_value(VCORE2_INDEX);
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_vcore2_en_sel(0)]\n");
                mt6331_upmu_set_vcore2_en_sel(0);
                exec_scrxxx_map(VCORE2_INDEX);

                pr_notice("[mt6331_upmu_set_vcore2_en_sel(1)]\n");
                mt6331_upmu_set_vcore2_en_sel(1);
                exec_scrxxx_map(VCORE2_INDEX);

                pr_notice("[mt6331_upmu_set_vcore2_en_sel(2)]\n");
                mt6331_upmu_set_vcore2_en_sel(2);
                exec_scrxxx_map(VCORE2_INDEX);

                pr_notice("[mt6331_upmu_set_vcore2_en_sel(3)]\n");
...
void exec_vio18_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vio18_en_ctrl] %d\n", i);
        mt6331_upmu_set_vio18_en_ctrl(i);

        switch(i){
            case 0:
                pr_notice("[mt6331_upmu_set_vio18_en(0)]\n");
                mt6331_upmu_set_vio18_en(0);
                read_adc_value(VIO18_INDEX);

                pr_notice("[mt6331_upmu_set_vio18_en(1)]\n");
                mt6331_upmu_set_vio18_en(1);
                read_adc_value(VIO18_INDEX);
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_vio18_en_sel(0)]\n");
                mt6331_upmu_set_vio18_en_sel(0);
                exec_scrxxx_map(VIO18_INDEX);

                pr_notice("[mt6331_upmu_set_vio18_en_sel(1)]\n");
                mt6331_upmu_set_vio18_en_sel(1);
                exec_scrxxx_map(VIO18_INDEX);

                pr_notice("[mt6331_upmu_set_vio18_en_sel(2)]\n");
                mt6331_upmu_set_vio18_en_sel(2);
                exec_scrxxx_map(VIO18_INDEX);

                pr_notice("[mt6331_upmu_set_vio18_en_sel(3)]\n");
...
void exec_vdram_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vdram_en_ctrl] %d\n", i);
        mt6332_upmu_set_vdram_en_ctrl(i);

        switch(i){
            case 0:
                pr_notice("[mt6332_upmu_set_vdram_en(0)]\n");
                mt6332_upmu_set_vdram_en(0);
                read_adc_value(VDRAM_INDEX);

                pr_notice("[mt6332_upmu_set_vdram_en(1)]\n");
                mt6332_upmu_set_vdram_en(1);
                read_adc_value(VDRAM_INDEX);
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_vdram_en_sel(0)]\n");
                mt6332_upmu_set_vdram_en_sel(0);
                exec_scrxxx_map(VDRAM_INDEX);

                pr_notice("[mt6332_upmu_set_vdram_en_sel(1)]\n");
                mt6332_upmu_set_vdram_en_sel(1);
                exec_scrxxx_map(VDRAM_INDEX);

                pr_notice("[mt6332_upmu_set_vdram_en_sel(2)]\n");
                mt6332_upmu_set_vdram_en_sel(2);
                exec_scrxxx_map(VDRAM_INDEX);

                pr_notice("[mt6332_upmu_set_vdram_en_sel(3)]\n");
...
void exec_vdvfs2_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vdvfs2_en_ctrl] %d\n", i);
        mt6332_upmu_set_vdvfs2_en_ctrl(i);

        switch(i){
            case 0:
                pr_notice("[mt6332_upmu_set_vdvfs2_en(0)]\n");
                mt6332_upmu_set_vdvfs2_en(0);
                read_adc_value(VDVFS2_INDEX);

                pr_notice("[mt6332_upmu_set_vdvfs2_en(1)]\n");
                mt6332_upmu_set_vdvfs2_en(1);
                read_adc_value(VDVFS2_INDEX);
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_vdvfs2_en_sel(0)]\n");
                mt6332_upmu_set_vdvfs2_en_sel(0);
                exec_scrxxx_map(VDVFS2_INDEX);

                pr_notice("[mt6332_upmu_set_vdvfs2_en_sel(1)]\n");
                mt6332_upmu_set_vdvfs2_en_sel(1);
                exec_scrxxx_map(VDVFS2_INDEX);

                pr_notice("[mt6332_upmu_set_vdvfs2_en_sel(2)]\n");
                mt6332_upmu_set_vdvfs2_en_sel(2);
                exec_scrxxx_map(VDVFS2_INDEX);

                pr_notice("[mt6332_upmu_set_vdvfs2_en_sel(3)]\n");
...
void exec_vrf1_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vrf1_en_ctrl] %d\n", i);
        mt6332_upmu_set_vrf1_en_ctrl(i);

        switch(i){
            case 0:
                pr_notice("[mt6332_upmu_set_vrf1_en(0)]\n");
                mt6332_upmu_set_vrf1_en(0);
                read_adc_value(VRF1_INDEX);

                pr_notice("[mt6332_upmu_set_vrf1_en(1)]\n");
                mt6332_upmu_set_vrf1_en(1);
                read_adc_value(VRF1_INDEX);
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_vrf1_en_sel(0)]\n");
                mt6332_upmu_set_vrf1_en_sel(0);
                exec_scrxxx_map(VRF1_INDEX);

                pr_notice("[mt6332_upmu_set_vrf1_en_sel(1)]\n");
                mt6332_upmu_set_vrf1_en_sel(1);
                exec_scrxxx_map(VRF1_INDEX);

                pr_notice("[mt6332_upmu_set_vrf1_en_sel(2)]\n");
                mt6332_upmu_set_vrf1_en_sel(2);
                exec_scrxxx_map(VRF1_INDEX);

                pr_notice("[mt6332_upmu_set_vrf1_en_sel(3)]\n");
...
void exec_vrf2_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vrf2_en_ctrl] %d\n", i);
        mt6332_upmu_set_vrf2_en_ctrl(i);

        switch(i){
            case 0:
                pr_notice("[mt6332_upmu_set_vrf2_en(0)]\n");
                mt6332_upmu_set_vrf2_en(0);
                read_adc_value(VRF2_INDEX);

                pr_notice("[mt6332_upmu_set_vrf2_en(1)]\n");
                mt6332_upmu_set_vrf2_en(1);
                read_adc_value(VRF2_INDEX);
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_vrf2_en_sel(0)]\n");
                mt6332_upmu_set_vrf2_en_sel(0);
                exec_scrxxx_map(VRF2_INDEX);

                pr_notice("[mt6332_upmu_set_vrf2_en_sel(1)]\n");
                mt6332_upmu_set_vrf2_en_sel(1);
                exec_scrxxx_map(VRF2_INDEX);

                pr_notice("[mt6332_upmu_set_vrf2_en_sel(2)]\n");
                mt6332_upmu_set_vrf2_en_sel(2);
                exec_scrxxx_map(VRF2_INDEX);

                pr_notice("[mt6332_upmu_set_vrf2_en_sel(3)]\n");
...
void exec_vpa_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vpa_en_ctrl] %d\n", i);
        mt6332_upmu_set_vpa_en_ctrl(i);

        switch(i){
            case 0:
                pr_notice("[mt6332_upmu_set_vpa_en(0)]\n");
                mt6332_upmu_set_vpa_en(0);
                read_adc_value(VPA_INDEX);

                pr_notice("[mt6332_upmu_set_vpa_en(1)]\n");
                mt6332_upmu_set_vpa_en(1);
                read_adc_value(VPA_INDEX);
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_vpa_en_sel(0)]\n");
                mt6332_upmu_set_vpa_en_sel(0);
                exec_scrxxx_map(VPA_INDEX);

                pr_notice("[mt6332_upmu_set_vpa_en_sel(1)]\n");
                mt6332_upmu_set_vpa_en_sel(1);
                exec_scrxxx_map(VPA_INDEX);

                pr_notice("[mt6332_upmu_set_vpa_en_sel(2)]\n");
                mt6332_upmu_set_vpa_en_sel(2);
                exec_scrxxx_map(VPA_INDEX);

                pr_notice("[mt6332_upmu_set_vpa_en_sel(3)]\n");
...
void exec_vsbst_en_test(void)
{
    ...
    pr_notice("[exec_vsbst_en_test] mt6332_upmu_set_rg_vsbst_3m_ck_pdn(0);\n");
    mt6332_upmu_set_rg_vsbst_3m_ck_pdn(0);

    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vsbst_en_ctrl] %d\n", i);
        mt6332_upmu_set_vsbst_en_ctrl(i);

        switch(i){
            case 0:
                pr_notice("[mt6332_upmu_set_vsbst_en(0)]\n");
                mt6332_upmu_set_vsbst_en(0);
                read_adc_value(VSBST_INDEX);

                pr_notice("[mt6332_upmu_set_vsbst_en(1)]\n");
                mt6332_upmu_set_vsbst_en(1);
                read_adc_value(VSBST_INDEX);
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_vsbst_en_sel(0)]\n");
                mt6332_upmu_set_vsbst_en_sel(0);
                exec_scrxxx_map(VSBST_INDEX);

                pr_notice("[mt6332_upmu_set_vsbst_en_sel(1)]\n");
                mt6332_upmu_set_vsbst_en_sel(1);
                exec_scrxxx_map(VSBST_INDEX);

                pr_notice("[mt6332_upmu_set_vsbst_en_sel(2)]\n");
                mt6332_upmu_set_vsbst_en_sel(2);
                exec_scrxxx_map(VSBST_INDEX);

                pr_notice("[mt6332_upmu_set_vsbst_en_sel(3)]\n");
...
void exec_vdvfs11_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6331_PMIC_VDVFS11_VOSEL_SLEEP_MASK;k++) {
        mt6331_upmu_set_vdvfs11_vosel_sleep(k); pr_notice("[mt6331_upmu_set_vdvfs11_vosel_sleep] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VDVFS11_INDEX);
    }
    for(k=0;k<=MT6331_PMIC_VDVFS11_VOSEL_ON_MASK;k++) {
        mt6331_upmu_set_vdvfs11_vosel_on(k); pr_notice("[mt6331_upmu_set_vdvfs11_vosel_on] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VDVFS11_INDEX);
    }
}
...
{
    pr_notice("[exec_vdvfs11_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vdvfs11_vosel_test_sub_vosel();

    pr_notice("[exec_vdvfs11_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vdvfs11_vosel_test_sub_vosel();

    pr_notice("[exec_vdvfs11_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vdvfs11_vosel_test_sub_vosel();

    pr_notice("[exec_vdvfs11_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vdvfs11_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vdvfs11_vosel_ctrl] %d\n", i);
        mt6331_upmu_set_vdvfs11_vosel_ctrl(i);

        switch(i){
            case 0:
                for(k=0;k<=MT6331_PMIC_VDVFS11_VOSEL_MASK;k++) {
                    mt6331_upmu_set_vdvfs11_vosel(k); pr_notice("[mt6331_upmu_set_vdvfs11_vosel] k=%d, ",k);
                    if(k==0) mdelay(500);
                    read_adc_value(VDVFS11_INDEX);
                }
                break;
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_vdvfs11_vosel_sel(0)]\n");
                mt6331_upmu_set_vdvfs11_vosel_sel(0);
                exec_vdvfs11_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vdvfs11_vosel_sel(1)]\n");
                mt6331_upmu_set_vdvfs11_vosel_sel(1);
                exec_vdvfs11_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vdvfs11_vosel_sel(2)]\n");
                mt6331_upmu_set_vdvfs11_vosel_sel(2);
                exec_vdvfs11_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vdvfs11_vosel_sel(3)]\n");
...
void exec_vdvfs12_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6331_PMIC_VDVFS12_VOSEL_SLEEP_MASK;k++) {
        mt6331_upmu_set_vdvfs12_vosel_sleep(k); pr_notice("[mt6331_upmu_set_vdvfs12_vosel_sleep] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VDVFS12_INDEX);
    }
    for(k=0;k<=MT6331_PMIC_VDVFS12_VOSEL_ON_MASK;k++) {
        mt6331_upmu_set_vdvfs12_vosel_on(k); pr_notice("[mt6331_upmu_set_vdvfs12_vosel_on] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VDVFS12_INDEX);
    }
}
...
{
    pr_notice("[exec_vdvfs12_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vdvfs12_vosel_test_sub_vosel();

    pr_notice("[exec_vdvfs12_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vdvfs12_vosel_test_sub_vosel();

    pr_notice("[exec_vdvfs12_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vdvfs12_vosel_test_sub_vosel();

    pr_notice("[exec_vdvfs12_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vdvfs12_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vdvfs12_vosel_ctrl] %d\n", i);
        mt6331_upmu_set_vdvfs12_vosel_ctrl(i);

        switch(i){
            case 0:
                for(k=0;k<=MT6331_PMIC_VDVFS12_VOSEL_MASK;k++) {
                    mt6331_upmu_set_vdvfs12_vosel(k); pr_notice("[mt6331_upmu_set_vdvfs12_vosel] k=%d, ",k);
                    if(k==0) mdelay(500);
                    read_adc_value(VDVFS12_INDEX);
                }
                break;
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_vdvfs12_vosel_sel(0)]\n");
                mt6331_upmu_set_vdvfs12_vosel_sel(0);
                exec_vdvfs12_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vdvfs12_vosel_sel(1)]\n");
                mt6331_upmu_set_vdvfs12_vosel_sel(1);
                exec_vdvfs12_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vdvfs12_vosel_sel(2)]\n");
                mt6331_upmu_set_vdvfs12_vosel_sel(2);
                exec_vdvfs12_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vdvfs12_vosel_sel(3)]\n");
...
void exec_vdvfs13_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6331_PMIC_VDVFS13_VOSEL_SLEEP_MASK;k++) {
        mt6331_upmu_set_vdvfs13_vosel_sleep(k); pr_notice("[mt6331_upmu_set_vdvfs13_vosel_sleep] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VDVFS13_INDEX);
    }
    for(k=0;k<=MT6331_PMIC_VDVFS13_VOSEL_ON_MASK;k++) {
        mt6331_upmu_set_vdvfs13_vosel_on(k); pr_notice("[mt6331_upmu_set_vdvfs13_vosel_on] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VDVFS13_INDEX);
    }
}
...
{
    pr_notice("[exec_vdvfs13_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vdvfs13_vosel_test_sub_vosel();

    pr_notice("[exec_vdvfs13_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vdvfs13_vosel_test_sub_vosel();

    pr_notice("[exec_vdvfs13_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vdvfs13_vosel_test_sub_vosel();

    pr_notice("[exec_vdvfs13_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vdvfs13_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vdvfs13_vosel_ctrl] %d\n", i);
        mt6331_upmu_set_vdvfs13_vosel_ctrl(i);

        switch(i){
            case 0:
                for(k=0;k<=MT6331_PMIC_VDVFS13_VOSEL_MASK;k++) {
                    mt6331_upmu_set_vdvfs13_vosel(k); pr_notice("[mt6331_upmu_set_vdvfs13_vosel] k=%d, ",k);
                    if(k==0) mdelay(500);
                    read_adc_value(VDVFS13_INDEX);
                }
                break;
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_vdvfs13_vosel_sel(0)]\n");
                mt6331_upmu_set_vdvfs13_vosel_sel(0);
                exec_vdvfs13_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vdvfs13_vosel_sel(1)]\n");
                mt6331_upmu_set_vdvfs13_vosel_sel(1);
                exec_vdvfs13_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vdvfs13_vosel_sel(2)]\n");
                mt6331_upmu_set_vdvfs13_vosel_sel(2);
                exec_vdvfs13_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vdvfs13_vosel_sel(3)]\n");
...
void exec_vdvfs14_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6331_PMIC_VDVFS14_VOSEL_SLEEP_MASK;k++) {
        mt6331_upmu_set_vdvfs14_vosel_sleep(k); pr_notice("[mt6331_upmu_set_vdvfs14_vosel_sleep] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VDVFS14_INDEX);
    }
    for(k=0;k<=MT6331_PMIC_VDVFS14_VOSEL_ON_MASK;k++) {
        mt6331_upmu_set_vdvfs14_vosel_on(k); pr_notice("[mt6331_upmu_set_vdvfs14_vosel_on] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VDVFS14_INDEX);
    }
}
...
{
    pr_notice("[exec_vdvfs14_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vdvfs14_vosel_test_sub_vosel();

    pr_notice("[exec_vdvfs14_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vdvfs14_vosel_test_sub_vosel();

    pr_notice("[exec_vdvfs14_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vdvfs14_vosel_test_sub_vosel();

    pr_notice("[exec_vdvfs14_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vdvfs14_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vdvfs14_vosel_ctrl] %d\n", i);
        mt6331_upmu_set_vdvfs14_vosel_ctrl(i);

        switch(i){
            case 0:
                for(k=0;k<=MT6331_PMIC_VDVFS14_VOSEL_MASK;k++) {
                    mt6331_upmu_set_vdvfs14_vosel(k); pr_notice("[mt6331_upmu_set_vdvfs14_vosel] k=%d, ",k);
                    if(k==0) mdelay(500);
                    read_adc_value(VDVFS14_INDEX);
                }
                break;
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_vdvfs14_vosel_sel(0)]\n");
                mt6331_upmu_set_vdvfs14_vosel_sel(0);
                exec_vdvfs14_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vdvfs14_vosel_sel(1)]\n");
                mt6331_upmu_set_vdvfs14_vosel_sel(1);
                exec_vdvfs14_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vdvfs14_vosel_sel(2)]\n");
                mt6331_upmu_set_vdvfs14_vosel_sel(2);
                exec_vdvfs14_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vdvfs14_vosel_sel(3)]\n");
...
void exec_vcore1_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6331_PMIC_VCORE1_VOSEL_SLEEP_MASK;k++) {
        mt6331_upmu_set_vcore1_vosel_sleep(k); pr_notice("[mt6331_upmu_set_vcore1_vosel_sleep] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VCORE1_INDEX);
    }
    for(k=0;k<=MT6331_PMIC_VCORE1_VOSEL_ON_MASK;k++) {
        mt6331_upmu_set_vcore1_vosel_on(k); pr_notice("[mt6331_upmu_set_vcore1_vosel_on] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VCORE1_INDEX);
    }
}
...
{
    pr_notice("[exec_vcore1_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vcore1_vosel_test_sub_vosel();

    pr_notice("[exec_vcore1_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vcore1_vosel_test_sub_vosel();

    pr_notice("[exec_vcore1_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vcore1_vosel_test_sub_vosel();

    pr_notice("[exec_vcore1_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vcore1_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vcore1_vosel_ctrl] %d\n", i);
        mt6331_upmu_set_vcore1_vosel_ctrl(i);

        switch(i){
            case 0:
                for(k=0;k<=MT6331_PMIC_VCORE1_VOSEL_MASK;k++) {
                    mt6331_upmu_set_vcore1_vosel(k); pr_notice("[mt6331_upmu_set_vcore1_vosel] k=%d, ",k);
                    if(k==0) mdelay(500);
                    read_adc_value(VCORE1_INDEX);
                }
                break;
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_vcore1_vosel_sel(0)]\n");
                mt6331_upmu_set_vcore1_vosel_sel(0);
                exec_vcore1_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vcore1_vosel_sel(1)]\n");
                mt6331_upmu_set_vcore1_vosel_sel(1);
                exec_vcore1_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vcore1_vosel_sel(2)]\n");
                mt6331_upmu_set_vcore1_vosel_sel(2);
                exec_vcore1_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vcore1_vosel_sel(3)]\n");
...
void exec_vcore2_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6331_PMIC_VCORE2_VOSEL_SLEEP_MASK;k++) {
        mt6331_upmu_set_vcore2_vosel_sleep(k); pr_notice("[mt6331_upmu_set_vcore2_vosel_sleep] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VCORE2_INDEX);
    }
    for(k=0;k<=MT6331_PMIC_VCORE2_VOSEL_ON_MASK;k++) {
        mt6331_upmu_set_vcore2_vosel_on(k); pr_notice("[mt6331_upmu_set_vcore2_vosel_on] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VCORE2_INDEX);
    }
}
...
{
    pr_notice("[exec_vcore2_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vcore2_vosel_test_sub_vosel();

    pr_notice("[exec_vcore2_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vcore2_vosel_test_sub_vosel();

    pr_notice("[exec_vcore2_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vcore2_vosel_test_sub_vosel();

    pr_notice("[exec_vcore2_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vcore2_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vcore2_vosel_ctrl] %d\n", i);
        mt6331_upmu_set_vcore2_vosel_ctrl(i);

        switch(i){
            case 0:
                for(k=0;k<=MT6331_PMIC_VCORE2_VOSEL_MASK;k++) {
                    mt6331_upmu_set_vcore2_vosel(k); pr_notice("[mt6331_upmu_set_vcore2_vosel] k=%d, ",k);
                    if(k==0) mdelay(500);
                    read_adc_value(VCORE2_INDEX);
                }
                break;
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_vcore2_vosel_sel(0)]\n");
                mt6331_upmu_set_vcore2_vosel_sel(0);
                exec_vcore2_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vcore2_vosel_sel(1)]\n");
                mt6331_upmu_set_vcore2_vosel_sel(1);
                exec_vcore2_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vcore2_vosel_sel(2)]\n");
                mt6331_upmu_set_vcore2_vosel_sel(2);
                exec_vcore2_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vcore2_vosel_sel(3)]\n");
...
void exec_vgpu_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6331_PMIC_VGPU_VOSEL_SLEEP_MASK;k++) {
        mt6331_upmu_set_vgpu_vosel_sleep(k); pr_notice("[mt6331_upmu_set_vgpu_vosel_sleep] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VGPU_INDEX);
    }
    for(k=0;k<=MT6331_PMIC_VGPU_VOSEL_ON_MASK;k++) {
        mt6331_upmu_set_vgpu_vosel_on(k); pr_notice("[mt6331_upmu_set_vgpu_vosel_on] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VGPU_INDEX);
    }
}
...
{
    pr_notice("[exec_vgpu_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vgpu_vosel_test_sub_vosel();

    pr_notice("[exec_vgpu_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vgpu_vosel_test_sub_vosel();

    pr_notice("[exec_vgpu_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vgpu_vosel_test_sub_vosel();

    pr_notice("[exec_vgpu_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vgpu_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vgpu_vosel_ctrl] %d\n", i);
        mt6331_upmu_set_vgpu_vosel_ctrl(i);

        switch(i){
            case 0:
                for(k=0;k<=MT6331_PMIC_VGPU_VOSEL_MASK;k++) {
                    mt6331_upmu_set_vgpu_vosel(k); pr_notice("[mt6331_upmu_set_vgpu_vosel] k=%d, ",k);
                    if(k==0) mdelay(500);
                    read_adc_value(VGPU_INDEX);
                }
                break;
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_vgpu_vosel_sel(0)]\n");
                mt6331_upmu_set_vgpu_vosel_sel(0);
                exec_vgpu_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vgpu_vosel_sel(1)]\n");
                mt6331_upmu_set_vgpu_vosel_sel(1);
                exec_vgpu_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vgpu_vosel_sel(2)]\n");
                mt6331_upmu_set_vgpu_vosel_sel(2);
                exec_vgpu_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vgpu_vosel_sel(3)]\n");
...
void exec_vio18_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6331_PMIC_VIO18_VOSEL_SLEEP_MASK;k++) {
        mt6331_upmu_set_vio18_vosel_sleep(k); pr_notice("[mt6331_upmu_set_vio18_vosel_sleep] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VIO18_INDEX);
    }
    for(k=0;k<=MT6331_PMIC_VIO18_VOSEL_ON_MASK;k++) {
        mt6331_upmu_set_vio18_vosel_on(k); pr_notice("[mt6331_upmu_set_vio18_vosel_on] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VIO18_INDEX);
    }
}
...
{
    pr_notice("[exec_vio18_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vio18_vosel_test_sub_vosel();

    pr_notice("[exec_vio18_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vio18_vosel_test_sub_vosel();

    pr_notice("[exec_vio18_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vio18_vosel_test_sub_vosel();

    pr_notice("[exec_vio18_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vio18_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vio18_vosel_ctrl] %d\n", i);
        mt6331_upmu_set_vio18_vosel_ctrl(i);

        switch(i){
            case 0:
                for(k=0;k<=MT6331_PMIC_VIO18_VOSEL_MASK;k++) {
                    mt6331_upmu_set_vio18_vosel(k); pr_notice("[mt6331_upmu_set_vio18_vosel] k=%d, ",k);
                    if(k==0) mdelay(500);
                    read_adc_value(VIO18_INDEX);
                }
                break;
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_vio18_vosel_sel(0)]\n");
                mt6331_upmu_set_vio18_vosel_sel(0);
                exec_vio18_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vio18_vosel_sel(1)]\n");
                mt6331_upmu_set_vio18_vosel_sel(1);
                exec_vio18_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vio18_vosel_sel(2)]\n");
                mt6331_upmu_set_vio18_vosel_sel(2);
                exec_vio18_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_vio18_vosel_sel(3)]\n");
...
void exec_vdram_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_VDRAM_VOSEL_SLEEP_MASK;k++) {
        mt6332_upmu_set_vdram_vosel_sleep(k); pr_notice("[mt6332_upmu_set_vdram_vosel_sleep] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VDRAM_INDEX);
    }
    for(k=0;k<=MT6332_PMIC_VDRAM_VOSEL_ON_MASK;k++) {
        mt6332_upmu_set_vdram_vosel_on(k); pr_notice("[mt6332_upmu_set_vdram_vosel_on] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VDRAM_INDEX);
    }
}
...
{
    pr_notice("[exec_vdram_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vdram_vosel_test_sub_vosel();

    pr_notice("[exec_vdram_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vdram_vosel_test_sub_vosel();

    pr_notice("[exec_vdram_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vdram_vosel_test_sub_vosel();

    pr_notice("[exec_vdram_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vdram_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vdram_vosel_ctrl] %d\n", i);
        mt6332_upmu_set_vdram_vosel_ctrl(i);

        switch(i){
            case 0:
                for(k=0;k<=MT6332_PMIC_VDRAM_VOSEL_MASK;k++) {
                    mt6332_upmu_set_vdram_vosel(k); pr_notice("[mt6332_upmu_set_vdram_vosel] k=%d, ",k);
                    if(k==0) mdelay(500);
                    read_adc_value(VDRAM_INDEX);
                }
                break;
            ...
            case 1:
                pr_notice("[mt6332_upmu_set_vdram_vosel_sel(0)]\n");
                mt6332_upmu_set_vdram_vosel_sel(0);
                exec_vdram_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vdram_vosel_sel(1)]\n");
                mt6332_upmu_set_vdram_vosel_sel(1);
                exec_vdram_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vdram_vosel_sel(2)]\n");
                mt6332_upmu_set_vdram_vosel_sel(2);
                exec_vdram_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vdram_vosel_sel(3)]\n");
...
void exec_vdvfs2_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_VDVFS2_VOSEL_SLEEP_MASK;k++) {
        mt6332_upmu_set_vdvfs2_vosel_sleep(k); pr_notice("[mt6332_upmu_set_vdvfs2_vosel_sleep] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VDVFS2_INDEX);
    }

    pr_notice("[exec_vdvfs2_vosel_test_sub_vosel] mt6332_upmu_set_vdvfs2_track_on_ctrl(0);\n"); mt6332_upmu_set_vdvfs2_track_on_ctrl(0);

    for(k=0;k<=MT6332_PMIC_VDVFS2_VOSEL_ON_MASK;k++) {
        mt6332_upmu_set_vdvfs2_vosel_on(k); pr_notice("[mt6332_upmu_set_vdvfs2_vosel_on] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VDVFS2_INDEX);
    }
}
...
{
    pr_notice("[exec_vdvfs2_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vdvfs2_vosel_test_sub_vosel();

    pr_notice("[exec_vdvfs2_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vdvfs2_vosel_test_sub_vosel();

    pr_notice("[exec_vdvfs2_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vdvfs2_vosel_test_sub_vosel();

    pr_notice("[exec_vdvfs2_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vdvfs2_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vdvfs2_vosel_ctrl] %d\n", i);
        mt6332_upmu_set_vdvfs2_vosel_ctrl(i);

        switch(i){
            case 0:
                for(k=0;k<=MT6332_PMIC_VDVFS2_VOSEL_MASK;k++) {
                    mt6332_upmu_set_vdvfs2_vosel(k); pr_notice("[mt6332_upmu_set_vdvfs2_vosel] k=%d, ",k);
                    if(k==0) mdelay(500);
                    read_adc_value(VDVFS2_INDEX);
                }
                break;
            ...
            case 1:
                pr_notice("[mt6332_upmu_set_vdvfs2_vosel_sel(0)]\n");
                mt6332_upmu_set_vdvfs2_vosel_sel(0);
                exec_vdvfs2_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vdvfs2_vosel_sel(1)]\n");
                mt6332_upmu_set_vdvfs2_vosel_sel(1);
                exec_vdvfs2_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vdvfs2_vosel_sel(2)]\n");
                mt6332_upmu_set_vdvfs2_vosel_sel(2);
                exec_vdvfs2_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vdvfs2_vosel_sel(3)]\n");
...
void exec_vrf1_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_VRF1_VOSEL_SLEEP_MASK;k++) {
        mt6332_upmu_set_vrf1_vosel_sleep(k); pr_notice("[mt6332_upmu_set_vrf1_vosel_sleep] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VRF1_INDEX);
    }
    for(k=0;k<=MT6332_PMIC_VRF1_VOSEL_ON_MASK;k++) {
        mt6332_upmu_set_vrf1_vosel_on(k); pr_notice("[mt6332_upmu_set_vrf1_vosel_on] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VRF1_INDEX);
    }
}
...
{
    pr_notice("[exec_vrf1_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vrf1_vosel_test_sub_vosel();

    pr_notice("[exec_vrf1_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vrf1_vosel_test_sub_vosel();

    pr_notice("[exec_vrf1_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vrf1_vosel_test_sub_vosel();

    pr_notice("[exec_vrf1_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vrf1_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vrf1_vosel_ctrl] %d\n", i);
        mt6332_upmu_set_vrf1_vosel_ctrl(i);

        switch(i){
            case 0:
                for(k=0;k<=MT6332_PMIC_VRF1_VOSEL_MASK;k++) {
                    mt6332_upmu_set_vrf1_vosel(k); pr_notice("[mt6332_upmu_set_vrf1_vosel] k=%d, ",k);
                    if(k==0) mdelay(500);
                    read_adc_value(VRF1_INDEX);
                }
                break;
            ...
            case 1:
                pr_notice("[mt6332_upmu_set_vrf1_vosel_sel(0)]\n");
                mt6332_upmu_set_vrf1_vosel_sel(0);
                exec_vrf1_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vrf1_vosel_sel(1)]\n");
                mt6332_upmu_set_vrf1_vosel_sel(1);
                exec_vrf1_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vrf1_vosel_sel(2)]\n");
                mt6332_upmu_set_vrf1_vosel_sel(2);
                exec_vrf1_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vrf1_vosel_sel(3)]\n");
...
void exec_vrf2_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_VRF2_VOSEL_SLEEP_MASK;k++) {
        mt6332_upmu_set_vrf2_vosel_sleep(k); pr_notice("[mt6332_upmu_set_vrf2_vosel_sleep] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VRF2_INDEX);
    }
    for(k=0;k<=MT6332_PMIC_VRF2_VOSEL_ON_MASK;k++) {
        mt6332_upmu_set_vrf2_vosel_on(k); pr_notice("[mt6332_upmu_set_vrf2_vosel_on] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VRF2_INDEX);
    }
}
...
{
    pr_notice("[exec_vrf2_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vrf2_vosel_test_sub_vosel();

    pr_notice("[exec_vrf2_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vrf2_vosel_test_sub_vosel();

    pr_notice("[exec_vrf2_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vrf2_vosel_test_sub_vosel();

    pr_notice("[exec_vrf2_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vrf2_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vrf2_vosel_ctrl] %d\n", i);
        mt6332_upmu_set_vrf2_vosel_ctrl(i);

        switch(i){
            case 0:
                for(k=0;k<=MT6332_PMIC_VRF2_VOSEL_MASK;k++) {
                    mt6332_upmu_set_vrf2_vosel(k); pr_notice("[mt6332_upmu_set_vrf2_vosel] k=%d, ",k);
                    if(k==0) mdelay(500);
                    read_adc_value(VRF2_INDEX);
                }
                break;
            ...
            case 1:
                pr_notice("[mt6332_upmu_set_vrf2_vosel_sel(0)]\n");
                mt6332_upmu_set_vrf2_vosel_sel(0);
                exec_vrf2_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vrf2_vosel_sel(1)]\n");
                mt6332_upmu_set_vrf2_vosel_sel(1);
                exec_vrf2_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vrf2_vosel_sel(2)]\n");
                mt6332_upmu_set_vrf2_vosel_sel(2);
                exec_vrf2_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vrf2_vosel_sel(3)]\n");
...
void exec_vpa_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_VPA_VOSEL_SLEEP_MASK;k++) {
        mt6332_upmu_set_vpa_vosel_sleep(k); pr_notice("[mt6332_upmu_set_vpa_vosel_sleep] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VPA_INDEX);
    }
    for(k=0;k<=MT6332_PMIC_VPA_VOSEL_ON_MASK;k++) {
        mt6332_upmu_set_vpa_vosel_on(k); pr_notice("[mt6332_upmu_set_vpa_vosel_on] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VPA_INDEX);
    }
}
...
{
    pr_notice("[exec_vpa_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vpa_vosel_test_sub_vosel();

    pr_notice("[exec_vpa_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vpa_vosel_test_sub_vosel();

    pr_notice("[exec_vpa_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vpa_vosel_test_sub_vosel();

    pr_notice("[exec_vpa_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vpa_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vpa_vosel_ctrl] %d\n", i);
        mt6332_upmu_set_vpa_vosel_ctrl(i);

        switch(i){
            case 0:
                for(k=0;k<=MT6332_PMIC_VPA_VOSEL_MASK;k++) {
                    mt6332_upmu_set_vpa_vosel(k); pr_notice("[mt6332_upmu_set_vpa_vosel] k=%d, ",k);
                    if(k==0) mdelay(500);
                    read_adc_value(VPA_INDEX);
                }
                break;
            ...
            case 1:
                pr_notice("[mt6332_upmu_set_vpa_vosel_sel(0)]\n");
                mt6332_upmu_set_vpa_vosel_sel(0);
                exec_vpa_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vpa_vosel_sel(1)]\n");
                mt6332_upmu_set_vpa_vosel_sel(1);
                exec_vpa_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vpa_vosel_sel(2)]\n");
                mt6332_upmu_set_vpa_vosel_sel(2);
                exec_vpa_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vpa_vosel_sel(3)]\n");
...
void exec_vsbst_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_VSBST_VOSEL_SLEEP_MASK;k++) {
        mt6332_upmu_set_vsbst_vosel_sleep(k); pr_notice("[mt6332_upmu_set_vsbst_vosel_sleep] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VSBST_INDEX);
    }
    for(k=0;k<=MT6332_PMIC_VSBST_VOSEL_ON_MASK;k++) {
        mt6332_upmu_set_vsbst_vosel_on(k); pr_notice("[mt6332_upmu_set_vsbst_vosel_on] k=%d, ",k);
        if(k==0) mdelay(500);
        read_adc_value(VSBST_INDEX);
    }
}
...
{
    pr_notice("[exec_vsbst_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vsbst_vosel_test_sub_vosel();

    pr_notice("[exec_vsbst_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vsbst_vosel_test_sub_vosel();

    pr_notice("[exec_vsbst_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vsbst_vosel_test_sub_vosel();

    pr_notice("[exec_vsbst_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vsbst_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vsbst_vosel_ctrl] %d\n", i);
        mt6332_upmu_set_vsbst_vosel_ctrl(i);

        switch(i){
            case 0:
                for(k=0;k<=MT6332_PMIC_VSBST_VOSEL_MASK;k++) {
                    mt6332_upmu_set_vsbst_vosel(k); pr_notice("[mt6332_upmu_set_vsbst_vosel] k=%d, ",k);
                    if(k==0) mdelay(500);
                    read_adc_value(VSBST_INDEX);
                }
                break;
            ...
            case 1:
                pr_notice("[mt6332_upmu_set_vsbst_vosel_sel(0)]\n");
                mt6332_upmu_set_vsbst_vosel_sel(0);
                exec_vsbst_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vsbst_vosel_sel(1)]\n");
                mt6332_upmu_set_vsbst_vosel_sel(1);
                exec_vsbst_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vsbst_vosel_sel(2)]\n");
                mt6332_upmu_set_vsbst_vosel_sel(2);
                exec_vsbst_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_vsbst_vosel_sel(3)]\n");
...
void exec_vgpu_dlc_test_sub_dlc(void)
{
    ...
    for(k=0;k<=MT6331_PMIC_VGPU_DLC_SLEEP_MASK;k++) {
        ...
        pr_notice("[exec_vgpu_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
    ...
    for(k=0;k<=MT6331_PMIC_VGPU_DLC_ON_MASK;k++) {
        ...
        pr_notice("[exec_vgpu_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
            k, k, mt6331_upmu_get_qi_vgpu_dlc(), mt6331_upmu_get_qi_vgpu_dlc_n());
    }
}
...
{
    pr_notice("[exec_vgpu_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vgpu_dlc_test_sub_dlc();

    pr_notice("[exec_vgpu_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vgpu_dlc_test_sub_dlc();

    pr_notice("[exec_vgpu_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vgpu_dlc_test_sub_dlc();

    pr_notice("[exec_vgpu_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vgpu_dlc_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vgpu_dlc_ctrl] %d\n", i);
        ...
        switch(i){
            case 0:
                for(k=0;k<=MT6331_PMIC_VGPU_DLC_MASK;k++) {
                    ...
                    pr_notice("[exec_vgpu_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
                        k, k, mt6331_upmu_get_qi_vgpu_dlc(), mt6331_upmu_get_qi_vgpu_dlc_n());
                }
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_vgpu_dlc_sel(0)]\n");
                mt6331_upmu_set_vgpu_dlc_sel(0);
                exec_vgpu_dlc_test_sub();

                pr_notice("[mt6331_upmu_set_vgpu_dlc_sel(1)]\n");
                mt6331_upmu_set_vgpu_dlc_sel(1);
                exec_vgpu_dlc_test_sub();

                pr_notice("[mt6331_upmu_set_vgpu_dlc_sel(2)]\n");
                mt6331_upmu_set_vgpu_dlc_sel(2);
                exec_vgpu_dlc_test_sub();

                pr_notice("[mt6331_upmu_set_vgpu_dlc_sel(3)]\n");
...
void exec_vcore1_dlc_test_sub_dlc(void)
{
    ...
    for(k=0;k<=MT6331_PMIC_VCORE1_DLC_SLEEP_MASK;k++) {
        ...
        pr_notice("[exec_vcore1_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
    ...
    for(k=0;k<=MT6331_PMIC_VCORE1_DLC_ON_MASK;k++) {
        ...
        pr_notice("[exec_vcore1_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
            k, k, mt6331_upmu_get_qi_vcore1_dlc(), mt6331_upmu_get_qi_vcore1_dlc_n());
    }
}
...
{
    pr_notice("[exec_vcore1_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vcore1_dlc_test_sub_dlc();

    pr_notice("[exec_vcore1_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vcore1_dlc_test_sub_dlc();

    pr_notice("[exec_vcore1_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vcore1_dlc_test_sub_dlc();

    pr_notice("[exec_vcore1_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vcore1_dlc_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vcore1_dlc_ctrl] %d\n", i);
        ...
        switch(i){
            case 0:
                for(k=0;k<=MT6331_PMIC_VCORE1_DLC_MASK;k++) {
                    ...
                    pr_notice("[exec_vcore1_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
                        k, k, mt6331_upmu_get_qi_vcore1_dlc(), mt6331_upmu_get_qi_vcore1_dlc_n());
                }
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_vcore1_dlc_sel(0)]\n");
                mt6331_upmu_set_vcore1_dlc_sel(0);
                exec_vcore1_dlc_test_sub();

                pr_notice("[mt6331_upmu_set_vcore1_dlc_sel(1)]\n");
                mt6331_upmu_set_vcore1_dlc_sel(1);
                exec_vcore1_dlc_test_sub();

                pr_notice("[mt6331_upmu_set_vcore1_dlc_sel(2)]\n");
                mt6331_upmu_set_vcore1_dlc_sel(2);
                exec_vcore1_dlc_test_sub();

                pr_notice("[mt6331_upmu_set_vcore1_dlc_sel(3)]\n");
...
void exec_vcore2_dlc_test_sub_dlc(void)
{
    ...
    for(k=0;k<=MT6331_PMIC_VCORE2_DLC_SLEEP_MASK;k++) {
        ...
        pr_notice("[exec_vcore2_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
    ...
    for(k=0;k<=MT6331_PMIC_VCORE2_DLC_ON_MASK;k++) {
        ...
        pr_notice("[exec_vcore2_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
            k, k, mt6331_upmu_get_qi_vcore2_dlc(), mt6331_upmu_get_qi_vcore2_dlc_n());
    }
}
...
{
    pr_notice("[exec_vcore2_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vcore2_dlc_test_sub_dlc();

    pr_notice("[exec_vcore2_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vcore2_dlc_test_sub_dlc();

    pr_notice("[exec_vcore2_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vcore2_dlc_test_sub_dlc();

    pr_notice("[exec_vcore2_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vcore2_dlc_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vcore2_dlc_ctrl] %d\n", i);
        ...
        switch(i){
            case 0:
                for(k=0;k<=MT6331_PMIC_VCORE2_DLC_MASK;k++) {
                    ...
                    pr_notice("[exec_vcore2_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
                        k, k, mt6331_upmu_get_qi_vcore2_dlc(), mt6331_upmu_get_qi_vcore2_dlc_n());
                }
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_vcore2_dlc_sel(0)]\n");
                mt6331_upmu_set_vcore2_dlc_sel(0);
                exec_vcore2_dlc_test_sub();

                pr_notice("[mt6331_upmu_set_vcore2_dlc_sel(1)]\n");
                mt6331_upmu_set_vcore2_dlc_sel(1);
                exec_vcore2_dlc_test_sub();

                pr_notice("[mt6331_upmu_set_vcore2_dlc_sel(2)]\n");
                mt6331_upmu_set_vcore2_dlc_sel(2);
                exec_vcore2_dlc_test_sub();

                pr_notice("[mt6331_upmu_set_vcore2_dlc_sel(3)]\n");
...
void exec_vio18_dlc_test_sub_dlc(void)
{
    ...
    for(k=0;k<=MT6331_PMIC_VIO18_DLC_SLEEP_MASK;k++) {
        ...
        pr_notice("[exec_vio18_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
    ...
    for(k=0;k<=MT6331_PMIC_VIO18_DLC_ON_MASK;k++) {
        ...
        pr_notice("[exec_vio18_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
            k, k, mt6331_upmu_get_qi_vio18_dlc(), mt6331_upmu_get_qi_vio18_dlc_n());
    }
}
...
{
    pr_notice("[exec_vio18_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vio18_dlc_test_sub_dlc();

    pr_notice("[exec_vio18_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vio18_dlc_test_sub_dlc();

    pr_notice("[exec_vio18_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vio18_dlc_test_sub_dlc();

    pr_notice("[exec_vio18_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vio18_dlc_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vio18_dlc_ctrl] %d\n", i);
        ...
        switch(i){
            case 0:
                for(k=0;k<=MT6331_PMIC_VIO18_DLC_MASK;k++) {
                    ...
                    pr_notice("[exec_vio18_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
                        k, k, mt6331_upmu_get_qi_vio18_dlc(), mt6331_upmu_get_qi_vio18_dlc_n());
                }
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_vio18_dlc_sel(0)]\n");
                mt6331_upmu_set_vio18_dlc_sel(0);
                exec_vio18_dlc_test_sub();

                pr_notice("[mt6331_upmu_set_vio18_dlc_sel(1)]\n");
                mt6331_upmu_set_vio18_dlc_sel(1);
                exec_vio18_dlc_test_sub();

                pr_notice("[mt6331_upmu_set_vio18_dlc_sel(2)]\n");
                mt6331_upmu_set_vio18_dlc_sel(2);
                exec_vio18_dlc_test_sub();

                pr_notice("[mt6331_upmu_set_vio18_dlc_sel(3)]\n");
...
void exec_vdram_dlc_test_sub_dlc(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_VDRAM_DLC_SLEEP_MASK;k++) {
        ...
        pr_notice("[exec_vdram_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
    ...
    for(k=0;k<=MT6332_PMIC_VDRAM_DLC_ON_MASK;k++) {
        ...
        pr_notice("[exec_vdram_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
            k, k, mt6332_upmu_get_qi_vdram_dlc(), mt6332_upmu_get_qi_vdram_dlc_n());
    }
}
...
{
    pr_notice("[exec_vdram_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vdram_dlc_test_sub_dlc();

    pr_notice("[exec_vdram_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vdram_dlc_test_sub_dlc();

    pr_notice("[exec_vdram_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vdram_dlc_test_sub_dlc();

    pr_notice("[exec_vdram_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vdram_dlc_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vdram_dlc_ctrl] %d\n", i);
        ...
        switch(i){
            case 0:
                for(k=0;k<=MT6332_PMIC_VDRAM_DLC_MASK;k++) {
                    ...
                    pr_notice("[exec_vdram_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
                        k, k, mt6332_upmu_get_qi_vdram_dlc(), mt6332_upmu_get_qi_vdram_dlc_n());
                }
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_vdram_dlc_sel(0)]\n");
                mt6332_upmu_set_vdram_dlc_sel(0);
                exec_vdram_dlc_test_sub();

                pr_notice("[mt6332_upmu_set_vdram_dlc_sel(1)]\n");
                mt6332_upmu_set_vdram_dlc_sel(1);
                exec_vdram_dlc_test_sub();

                pr_notice("[mt6332_upmu_set_vdram_dlc_sel(2)]\n");
                mt6332_upmu_set_vdram_dlc_sel(2);
                exec_vdram_dlc_test_sub();

                pr_notice("[mt6332_upmu_set_vdram_dlc_sel(3)]\n");
...
void exec_vdvfs2_dlc_test_sub_dlc(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_VDVFS2_DLC_SLEEP_MASK;k++) {
        ...
        pr_notice("[exec_vdvfs2_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
    ...
    for(k=0;k<=MT6332_PMIC_VDVFS2_DLC_ON_MASK;k++) {
        ...
        pr_notice("[exec_vdvfs2_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
            k, k, mt6332_upmu_get_qi_vdvfs2_dlc(), mt6332_upmu_get_qi_vdvfs2_dlc_n());
    }
}
...
{
    pr_notice("[exec_vdvfs2_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vdvfs2_dlc_test_sub_dlc();

    pr_notice("[exec_vdvfs2_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vdvfs2_dlc_test_sub_dlc();

    pr_notice("[exec_vdvfs2_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vdvfs2_dlc_test_sub_dlc();

    pr_notice("[exec_vdvfs2_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vdvfs2_dlc_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vdvfs2_dlc_ctrl] %d\n", i);
        ...
        switch(i){
            case 0:
                for(k=0;k<=MT6332_PMIC_VDVFS2_DLC_MASK;k++) {
                    ...
                    pr_notice("[exec_vdvfs2_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
                        k, k, mt6332_upmu_get_qi_vdvfs2_dlc(), mt6332_upmu_get_qi_vdvfs2_dlc_n());
                }
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_vdvfs2_dlc_sel(0)]\n");
                mt6332_upmu_set_vdvfs2_dlc_sel(0);
                exec_vdvfs2_dlc_test_sub();

                pr_notice("[mt6332_upmu_set_vdvfs2_dlc_sel(1)]\n");
                mt6332_upmu_set_vdvfs2_dlc_sel(1);
                exec_vdvfs2_dlc_test_sub();

                pr_notice("[mt6332_upmu_set_vdvfs2_dlc_sel(2)]\n");
                mt6332_upmu_set_vdvfs2_dlc_sel(2);
                exec_vdvfs2_dlc_test_sub();

                pr_notice("[mt6332_upmu_set_vdvfs2_dlc_sel(3)]\n");
...
void exec_vrf1_dlc_test_sub_dlc(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_VRF1_DLC_SLEEP_MASK;k++) {
        ...
        pr_notice("[exec_vrf1_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
    ...
    for(k=0;k<=MT6332_PMIC_VRF1_DLC_ON_MASK;k++) {
        ...
        pr_notice("[exec_vrf1_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
            k, k, mt6332_upmu_get_qi_vrf1_dlc(), mt6332_upmu_get_qi_vrf1_dlc_n());
    }
}
...
{
    pr_notice("[exec_vrf1_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vrf1_dlc_test_sub_dlc();

    pr_notice("[exec_vrf1_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vrf1_dlc_test_sub_dlc();

    pr_notice("[exec_vrf1_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vrf1_dlc_test_sub_dlc();

    pr_notice("[exec_vrf1_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vrf1_dlc_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vrf1_dlc_ctrl] %d\n", i);
        ...
        switch(i){
            case 0:
                for(k=0;k<=MT6332_PMIC_VRF1_DLC_MASK;k++) {
                    ...
                    pr_notice("[exec_vrf1_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
                        k, k, mt6332_upmu_get_qi_vrf1_dlc(), mt6332_upmu_get_qi_vrf1_dlc_n());
                }
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_vrf1_dlc_sel(0)]\n");
                mt6332_upmu_set_vrf1_dlc_sel(0);
                exec_vrf1_dlc_test_sub();

                pr_notice("[mt6332_upmu_set_vrf1_dlc_sel(1)]\n");
                mt6332_upmu_set_vrf1_dlc_sel(1);
                exec_vrf1_dlc_test_sub();

                pr_notice("[mt6332_upmu_set_vrf1_dlc_sel(2)]\n");
                mt6332_upmu_set_vrf1_dlc_sel(2);
                exec_vrf1_dlc_test_sub();

                pr_notice("[mt6332_upmu_set_vrf1_dlc_sel(3)]\n");
...
void exec_vrf2_dlc_test_sub_dlc(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_VRF2_DLC_SLEEP_MASK;k++) {
        ...
        pr_notice("[exec_vrf2_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
    ...
    for(k=0;k<=MT6332_PMIC_VRF2_DLC_ON_MASK;k++) {
        ...
        pr_notice("[exec_vrf2_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
            k, k, mt6332_upmu_get_qi_vrf2_dlc(), mt6332_upmu_get_qi_vrf2_dlc_n());
    }
}
...
{
    pr_notice("[exec_vrf2_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vrf2_dlc_test_sub_dlc();

    pr_notice("[exec_vrf2_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vrf2_dlc_test_sub_dlc();

    pr_notice("[exec_vrf2_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vrf2_dlc_test_sub_dlc();

    pr_notice("[exec_vrf2_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vrf2_dlc_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vrf2_dlc_ctrl] %d\n", i);
        ...
        switch(i){
            case 0:
                for(k=0;k<=MT6332_PMIC_VRF2_DLC_MASK;k++) {
                    ...
                    pr_notice("[exec_vrf2_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
                        k, k, mt6332_upmu_get_qi_vrf2_dlc(), mt6332_upmu_get_qi_vrf2_dlc_n());
                }
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_vrf2_dlc_sel(0)]\n");
                mt6332_upmu_set_vrf2_dlc_sel(0);
                exec_vrf2_dlc_test_sub();

                pr_notice("[mt6332_upmu_set_vrf2_dlc_sel(1)]\n");
                mt6332_upmu_set_vrf2_dlc_sel(1);
                exec_vrf2_dlc_test_sub();

                pr_notice("[mt6332_upmu_set_vrf2_dlc_sel(2)]\n");
                mt6332_upmu_set_vrf2_dlc_sel(2);
                exec_vrf2_dlc_test_sub();

                pr_notice("[mt6332_upmu_set_vrf2_dlc_sel(3)]\n");
...
{
    pr_notice("[exec_vpa_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vpa_dlc_test_sub_dlc();

    pr_notice("[exec_vpa_dlc_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vpa_dlc_test_sub_dlc();

    pr_notice("[exec_vpa_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vpa_dlc_test_sub_dlc();

    pr_notice("[exec_vpa_dlc_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
//-----------------------------------------------------------------
    pr_notice("[exec_vpa_dlc_test] mt6332_upmu_set_vpa_dlc_map_en(0);\n");
    mt6332_upmu_set_vpa_dlc_map_en(0);
//-----------------------------------------------------------------
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vpa_dlc_ctrl] %d\n", i);
        ...
        switch(i){
            ...
            case 1:
                pr_notice("[mt6332_upmu_set_vpa_dlc_sel(0)]\n");
                mt6332_upmu_set_vpa_dlc_sel(0);
                exec_vpa_dlc_test_sub();

                pr_notice("[mt6332_upmu_set_vpa_dlc_sel(1)]\n");
                mt6332_upmu_set_vpa_dlc_sel(1);
                exec_vpa_dlc_test_sub();

                pr_notice("[mt6332_upmu_set_vpa_dlc_sel(2)]\n");
                mt6332_upmu_set_vpa_dlc_sel(2);
                exec_vpa_dlc_test_sub();

                pr_notice("[mt6332_upmu_set_vpa_dlc_sel(3)]\n");
...
//-----------------------------------------------------------------
    pr_notice("[exec_vpa_dlc_test] mt6332_upmu_set_vpa_dlc_map_en(1);\n");
    mt6332_upmu_set_vpa_dlc_map_en(1);
//-----------------------------------------------------------------
    pr_notice("[exec_vpa_dlc_test] mt6332_upmu_set_vpa_vosel_dlc001(20);\n");
    pr_notice("[exec_vpa_dlc_test] mt6332_upmu_set_vpa_vosel_dlc011(30);\n");
    pr_notice("[exec_vpa_dlc_test] mt6332_upmu_set_vpa_vosel_dlc111(50);\n");
    mt6332_upmu_set_vpa_vosel_dlc001(20);
    mt6332_upmu_set_vpa_vosel_dlc011(30);
    mt6332_upmu_set_vpa_vosel_dlc111(50);

    pr_notice("[exec_vpa_dlc_test] mt6332_upmu_set_vpa_vosel_ctrl(0);\n");
...
void PMIC_BUCK_DLC(int index_val)
{
    ...
    switch(index_val){
      ...
      case 13: pr_notice("[PMIC_BUCK_DLC] no DLC function\n");                break;
...
{
    pr_notice("[exec_vgpu_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vgpu_burst_test_sub_burst();

    pr_notice("[exec_vgpu_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vgpu_burst_test_sub_burst();

    pr_notice("[exec_vgpu_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vgpu_burst_test_sub_burst();

    pr_notice("[exec_vgpu_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vgpu_burst_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vgpu_burst_ctrl] %d\n", i);
        ...
        switch(i){
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_vgpu_burst_sel(0)]\n");
                mt6331_upmu_set_vgpu_burst_sel(0);
                exec_vgpu_burst_test_sub();

                pr_notice("[mt6331_upmu_set_vgpu_burst_sel(1)]\n");
                mt6331_upmu_set_vgpu_burst_sel(1);
                exec_vgpu_burst_test_sub();

                pr_notice("[mt6331_upmu_set_vgpu_burst_sel(2)]\n");
                mt6331_upmu_set_vgpu_burst_sel(2);
                exec_vgpu_burst_test_sub();

                pr_notice("[mt6331_upmu_set_vgpu_burst_sel(3)]\n");
...
{
    pr_notice("[exec_vcore1_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vcore1_burst_test_sub_burst();

    pr_notice("[exec_vcore1_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vcore1_burst_test_sub_burst();

    pr_notice("[exec_vcore1_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vcore1_burst_test_sub_burst();

    pr_notice("[exec_vcore1_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vcore1_burst_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vcore1_burst_ctrl] %d\n", i);
        ...
        switch(i){
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_vcore1_burst_sel(0)]\n");
                mt6331_upmu_set_vcore1_burst_sel(0);
                exec_vcore1_burst_test_sub();

                pr_notice("[mt6331_upmu_set_vcore1_burst_sel(1)]\n");
                mt6331_upmu_set_vcore1_burst_sel(1);
                exec_vcore1_burst_test_sub();

                pr_notice("[mt6331_upmu_set_vcore1_burst_sel(2)]\n");
                mt6331_upmu_set_vcore1_burst_sel(2);
                exec_vcore1_burst_test_sub();

                pr_notice("[mt6331_upmu_set_vcore1_burst_sel(3)]\n");
...
{
    pr_notice("[exec_vcore2_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vcore2_burst_test_sub_burst();

    pr_notice("[exec_vcore2_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vcore2_burst_test_sub_burst();

    pr_notice("[exec_vcore2_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vcore2_burst_test_sub_burst();

    pr_notice("[exec_vcore2_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vcore2_burst_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vcore2_burst_ctrl] %d\n", i);
        ...
        switch(i){
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_vcore2_burst_sel(0)]\n");
                mt6331_upmu_set_vcore2_burst_sel(0);
                exec_vcore2_burst_test_sub();

                pr_notice("[mt6331_upmu_set_vcore2_burst_sel(1)]\n");
                mt6331_upmu_set_vcore2_burst_sel(1);
                exec_vcore2_burst_test_sub();

                pr_notice("[mt6331_upmu_set_vcore2_burst_sel(2)]\n");
                mt6331_upmu_set_vcore2_burst_sel(2);
                exec_vcore2_burst_test_sub();

                pr_notice("[mt6331_upmu_set_vcore2_burst_sel(3)]\n");
...
{
    pr_notice("[exec_vio18_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vio18_burst_test_sub_burst();

    pr_notice("[exec_vio18_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vio18_burst_test_sub_burst();

    pr_notice("[exec_vio18_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vio18_burst_test_sub_burst();

    pr_notice("[exec_vio18_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vio18_burst_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_vio18_burst_ctrl] %d\n", i);
        ...
        switch(i){
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_vio18_burst_sel(0)]\n");
                mt6331_upmu_set_vio18_burst_sel(0);
                exec_vio18_burst_test_sub();

                pr_notice("[mt6331_upmu_set_vio18_burst_sel(1)]\n");
                mt6331_upmu_set_vio18_burst_sel(1);
                exec_vio18_burst_test_sub();

                pr_notice("[mt6331_upmu_set_vio18_burst_sel(2)]\n");
                mt6331_upmu_set_vio18_burst_sel(2);
                exec_vio18_burst_test_sub();

                pr_notice("[mt6331_upmu_set_vio18_burst_sel(3)]\n");
...
{
    pr_notice("[exec_vdram_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vdram_burst_test_sub_burst();

    pr_notice("[exec_vdram_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vdram_burst_test_sub_burst();

    pr_notice("[exec_vdram_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vdram_burst_test_sub_burst();

    pr_notice("[exec_vdram_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vdram_burst_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vdram_burst_ctrl] %d\n", i);
        ...
        switch(i){
            ...
            case 1:
                pr_notice("[mt6332_upmu_set_vdram_burst_sel(0)]\n");
                mt6332_upmu_set_vdram_burst_sel(0);
                exec_vdram_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vdram_burst_sel(1)]\n");
                mt6332_upmu_set_vdram_burst_sel(1);
                exec_vdram_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vdram_burst_sel(2)]\n");
                mt6332_upmu_set_vdram_burst_sel(2);
                exec_vdram_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vdram_burst_sel(3)]\n");
...
void exec_vdvfs2_burst_test_sub_burst(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_VDVFS2_BURST_SLEEP_MASK;k++) {
        ...
        pr_notice("[exec_vdvfs2_burst_test_sub_burst] burst_sleep=%d, qi_burst=%d\n", k, mt6332_upmu_get_qi_vdvfs2_burst());
    }

    for(k=0;k<=MT6332_PMIC_VDVFS2_BURST_ON_MASK;k++) {
        mt6332_upmu_set_vdvfs2_burst_on(k);
        pr_notice("[exec_vdvfs2_burst_test_sub_burst] burst_on=%d, qi_burst=%d\n", k, mt6332_upmu_get_qi_vdvfs2_burst());
    }
}

void exec_vdvfs2_burst_test_sub(void)
{
    pr_notice("[exec_vdvfs2_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vdvfs2_burst_test_sub_burst();

    pr_notice("[exec_vdvfs2_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vdvfs2_burst_test_sub_burst();

    pr_notice("[exec_vdvfs2_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vdvfs2_burst_test_sub_burst();

    pr_notice("[exec_vdvfs2_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vdvfs2_burst_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vdvfs2_burst_ctrl] %d\n", i);
        ...
        switch(i){
            case 0:
                for(k=0;k<=MT6332_PMIC_VDVFS2_BURST_MASK;k++) {
                    ...
                    pr_notice("[exec_vdvfs2_burst_test] burst=%d, qi_burst=%d\n", k, mt6332_upmu_get_qi_vdvfs2_burst());
                }
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_vdvfs2_burst_sel(0)]\n");
                mt6332_upmu_set_vdvfs2_burst_sel(0);
                exec_vdvfs2_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vdvfs2_burst_sel(1)]\n");
                mt6332_upmu_set_vdvfs2_burst_sel(1);
                exec_vdvfs2_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vdvfs2_burst_sel(2)]\n");
                mt6332_upmu_set_vdvfs2_burst_sel(2);
                exec_vdvfs2_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vdvfs2_burst_sel(3)]\n");
...
void exec_vrf1_burst_test_sub_burst(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_VRF1_BURST_SLEEP_MASK;k++) {
        ...
        pr_notice("[exec_vrf1_burst_test_sub_burst] burst_sleep=%d, qi_burst=%d\n", k, mt6332_upmu_get_qi_vrf1_burst());
    }

    for(k=0;k<=MT6332_PMIC_VRF1_BURST_ON_MASK;k++) {
        mt6332_upmu_set_vrf1_burst_on(k);
        pr_notice("[exec_vrf1_burst_test_sub_burst] burst_on=%d, qi_burst=%d\n", k, mt6332_upmu_get_qi_vrf1_burst());
    }
}

void exec_vrf1_burst_test_sub(void)
{
    pr_notice("[exec_vrf1_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vrf1_burst_test_sub_burst();

    pr_notice("[exec_vrf1_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vrf1_burst_test_sub_burst();

    pr_notice("[exec_vrf1_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vrf1_burst_test_sub_burst();

    pr_notice("[exec_vrf1_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vrf1_burst_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vrf1_burst_ctrl] %d\n", i);
        ...
        switch(i){
            case 0:
                for(k=0;k<=MT6332_PMIC_VRF1_BURST_MASK;k++) {
                    ...
                    pr_notice("[exec_vrf1_burst_test] burst=%d, qi_burst=%d\n", k, mt6332_upmu_get_qi_vrf1_burst());
                }
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_vrf1_burst_sel(0)]\n");
                mt6332_upmu_set_vrf1_burst_sel(0);
                exec_vrf1_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vrf1_burst_sel(1)]\n");
                mt6332_upmu_set_vrf1_burst_sel(1);
                exec_vrf1_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vrf1_burst_sel(2)]\n");
                mt6332_upmu_set_vrf1_burst_sel(2);
                exec_vrf1_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vrf1_burst_sel(3)]\n");
...
void exec_vrf2_burst_test_sub_burst(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_VRF2_BURST_SLEEP_MASK;k++) {
        ...
        pr_notice("[exec_vrf2_burst_test_sub_burst] burst_sleep=%d, qi_burst=%d\n", k, mt6332_upmu_get_qi_vrf2_burst());
    }

    for(k=0;k<=MT6332_PMIC_VRF2_BURST_ON_MASK;k++) {
        mt6332_upmu_set_vrf2_burst_on(k);
        pr_notice("[exec_vrf2_burst_test_sub_burst] burst_on=%d, qi_burst=%d\n", k, mt6332_upmu_get_qi_vrf2_burst());
    }
}

void exec_vrf2_burst_test_sub(void)
{
    pr_notice("[exec_vrf2_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vrf2_burst_test_sub_burst();

    pr_notice("[exec_vrf2_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vrf2_burst_test_sub_burst();

    pr_notice("[exec_vrf2_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vrf2_burst_test_sub_burst();

    pr_notice("[exec_vrf2_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vrf2_burst_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vrf2_burst_ctrl] %d\n", i);
        ...
        switch(i){
            case 0:
                for(k=0;k<=MT6332_PMIC_VRF2_BURST_MASK;k++) {
                    ...
                    pr_notice("[exec_vrf2_burst_test] burst=%d, qi_burst=%d\n", k, mt6332_upmu_get_qi_vrf2_burst());
                }
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_vrf2_burst_sel(0)]\n");
                mt6332_upmu_set_vrf2_burst_sel(0);
                exec_vrf2_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vrf2_burst_sel(1)]\n");
                mt6332_upmu_set_vrf2_burst_sel(1);
                exec_vrf2_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vrf2_burst_sel(2)]\n");
                mt6332_upmu_set_vrf2_burst_sel(2);
                exec_vrf2_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vrf2_burst_sel(3)]\n");
...
void exec_vpa_burst_test_sub_burst(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_VPA_BURSTH_SLEEP_MASK;k++) {
        ...
        pr_notice("[exec_vpa_burst_test_sub_burst] bursth_sleep=%d, burstl_sleep=%d, qi_bursth=%d, qi_burstl=%d\n",
    ...
    for(k=0;k<=MT6332_PMIC_VPA_BURSTH_ON_MASK;k++) {
        ...
        pr_notice("[exec_vpa_burst_test_sub_burst] bursth_on=%d, burstl_on=%d, qi_bursth=%d, qi_burstl=%d\n",
            k, k, mt6332_upmu_get_qi_vpa_bursth(), mt6332_upmu_get_qi_vpa_burstl());
    }
}
...
{
    pr_notice("[exec_vpa_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vpa_burst_test_sub_burst();

    pr_notice("[exec_vpa_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vpa_burst_test_sub_burst();

    pr_notice("[exec_vpa_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vpa_burst_test_sub_burst();

    pr_notice("[exec_vpa_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vpa_burst_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vpa_burst_ctrl] %d\n", i);
        ...
        switch(i){
            case 0:
                for(k=0;k<=MT6332_PMIC_VPA_BURSTH_MASK;k++) {
                    ...
                    pr_notice("[exec_vpa_burst_test] bursth=%d, burstl=%d, qi_bursth=%d, qi_burstl=%d\n",
                        k, k, mt6332_upmu_get_qi_vpa_bursth(), mt6332_upmu_get_qi_vpa_burstl());
                }
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_vpa_burst_sel(0)]\n");
                mt6332_upmu_set_vpa_burst_sel(0);
                exec_vpa_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vpa_burst_sel(1)]\n");
                mt6332_upmu_set_vpa_burst_sel(1);
                exec_vpa_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vpa_burst_sel(2)]\n");
                mt6332_upmu_set_vpa_burst_sel(2);
                exec_vpa_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vpa_burst_sel(3)]\n");
...
void exec_vsbst_burst_test_sub_burst(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_VSBST_BURSTH_SLEEP_MASK;k++) {
        ...
        pr_notice("[exec_vsbst_burst_test_sub_burst] bursth_sleep=%d, burstl_sleep=%d, qi_bursth=%d, qi_burstl=%d\n",
    ...
    for(k=0;k<=MT6332_PMIC_VSBST_BURSTH_ON_MASK;k++) {
        ...
        pr_notice("[exec_vsbst_burst_test_sub_burst] bursth_on=%d, burstl_on=%d, qi_bursth=%d, qi_burstl=%d\n",
            k, k, mt6332_upmu_get_qi_vsbst_bursth(), mt6332_upmu_get_qi_vsbst_burstl());
    }
}
...
{
    pr_notice("[exec_vsbst_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_vsbst_burst_test_sub_burst();

    pr_notice("[exec_vsbst_burst_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_vsbst_burst_test_sub_burst();

    pr_notice("[exec_vsbst_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_vsbst_burst_test_sub_burst();

    pr_notice("[exec_vsbst_burst_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_vsbst_burst_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_vsbst_burst_ctrl] %d\n", i);
        ...
        switch(i){
            case 0:
                for(k=0;k<=MT6332_PMIC_VSBST_BURSTH_MASK;k++) {
                    ...
                    pr_notice("[exec_vsbst_burst_test] bursth=%d, burstl=%d, qi_bursth=%d, qi_burstl=%d\n",
                        k, k, mt6332_upmu_get_qi_vsbst_bursth(), mt6332_upmu_get_qi_vsbst_burstl());
                }
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_vsbst_burst_sel(0)]\n");
                mt6332_upmu_set_vsbst_burst_sel(0);
                exec_vsbst_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vsbst_burst_sel(1)]\n");
                mt6332_upmu_set_vsbst_burst_sel(1);
                exec_vsbst_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vsbst_burst_sel(2)]\n");
                mt6332_upmu_set_vsbst_burst_sel(2);
                exec_vsbst_burst_test_sub();

                pr_notice("[mt6332_upmu_set_vsbst_burst_sel(3)]\n");
...
void PMIC_BUCK_BURST(int index_val)
{
    ...
    switch(index_val){
      //MT6331
      case 0 : pr_notice("[PMIC_BUCK_BURST] no BURST function\n");              break;
      case 1 : pr_notice("[PMIC_BUCK_BURST] no BURST function\n");              break;
      case 2 : pr_notice("[PMIC_BUCK_BURST] no BURST function\n");              break;
      case 3 : pr_notice("[PMIC_BUCK_BURST] no BURST function\n");              break;
...
void exec_6331_ldo_vtcxo1_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vtcxo1_on_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vtcxo1_on_ctrl(i);

        switch(i){
            case 0:
                pr_notice("hwPowerOn(MT6331_POWER_LDO_VTCXO1]\n");
                        hwPowerOn(MT6331_POWER_LDO_VTCXO1, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

                pr_notice("hwPowerDown(MT6331_POWER_LDO_VTCXO1]\n");
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_rg_vtcxo1_srclk_en_sel(0)]\n");
                         mt6331_upmu_set_rg_vtcxo1_srclk_en_sel(0); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vtcxo1_srclk_en_sel(1)]\n");
                         mt6331_upmu_set_rg_vtcxo1_srclk_en_sel(1); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vtcxo1_srclk_en_sel(2)]\n");
                         mt6331_upmu_set_rg_vtcxo1_srclk_en_sel(2); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vtcxo1_srclk_en_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vtcxo1_on_ctrl(0);\n"); mt6331_upmu_set_rg_vtcxo1_on_ctrl(0);
}
...
void exec_6331_ldo_vtcxo2_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vtcxo2_on_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vtcxo2_on_ctrl(i);

        switch(i){
            case 0:
                pr_notice("hwPowerOn(MT6331_POWER_LDO_VTCXO2]\n");
                        hwPowerOn(MT6331_POWER_LDO_VTCXO2, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

                pr_notice("hwPowerDown(MT6331_POWER_LDO_VTCXO2]\n");
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_rg_vtcxo2_srclk_en_sel(0)]\n");
                         mt6331_upmu_set_rg_vtcxo2_srclk_en_sel(0); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vtcxo2_srclk_en_sel(1)]\n");
                         mt6331_upmu_set_rg_vtcxo2_srclk_en_sel(1); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vtcxo2_srclk_en_sel(2)]\n");
                         mt6331_upmu_set_rg_vtcxo2_srclk_en_sel(2); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vtcxo2_srclk_en_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vtcxo2_on_ctrl(0);\n"); mt6331_upmu_set_rg_vtcxo2_on_ctrl(0);
}
...
void exec_6331_ldo_vaud32_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vaud32_on_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vaud32_on_ctrl(i);

        switch(i){
            case 0:
                pr_notice("hwPowerOn(MT6331_POWER_LDO_VAUD32]\n");
                        hwPowerOn(MT6331_POWER_LDO_VAUD32, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

                pr_notice("hwPowerDown(MT6331_POWER_LDO_VAUD32]\n");
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_rg_vaud32_srclk_en_sel(0)]\n");
                         mt6331_upmu_set_rg_vaud32_srclk_en_sel(0); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vaud32_srclk_en_sel(1)]\n");
                         mt6331_upmu_set_rg_vaud32_srclk_en_sel(1); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vaud32_srclk_en_sel(2)]\n");
                         mt6331_upmu_set_rg_vaud32_srclk_en_sel(2); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vaud32_srclk_en_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vaud32_on_ctrl(0);\n"); mt6331_upmu_set_rg_vaud32_on_ctrl(0);
}
...
void exec_6331_ldo_vauxa32_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vauxa32_on_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vauxa32_on_ctrl(i);

        switch(i){
            case 0:
                pr_notice("hwPowerOn(MT6331_POWER_LDO_VAUXA32]\n");
                        hwPowerOn(MT6331_POWER_LDO_VAUXA32, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

                pr_notice("hwPowerDown(MT6331_POWER_LDO_VAUXA32]\n");
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_rg_vauxa32_srclk_en_sel(0)]\n");
                         mt6331_upmu_set_rg_vauxa32_srclk_en_sel(0); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vauxa32_srclk_en_sel(1)]\n");
                         mt6331_upmu_set_rg_vauxa32_srclk_en_sel(1); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vauxa32_srclk_en_sel(2)]\n");
                         mt6331_upmu_set_rg_vauxa32_srclk_en_sel(2); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vauxa32_srclk_en_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vauxa32_on_ctrl(0);\n"); mt6331_upmu_set_rg_vauxa32_on_ctrl(0);
}

void exec_6331_ldo_vcama_en_test(void)
{
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VCAMA]\n");
            hwPowerOn(MT6331_POWER_LDO_VCAMA, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerDown(MT6331_POWER_LDO_VCAMA]\n");
...
{
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VIO28]\n");
            hwPowerOn(MT6331_POWER_LDO_VIO28, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerDown(MT6331_POWER_LDO_VIO28]\n");
...
{
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VCAM_AF]\n");
            hwPowerOn(MT6331_POWER_LDO_VCAM_AF, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerDown(MT6331_POWER_LDO_VCAM_AF]\n");
...
void exec_6331_ldo_vmc_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vmc_on_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vmc_on_ctrl(i);

        switch(i){
            case 0:
                pr_notice("hwPowerOn(MT6331_POWER_LDO_VMC]\n");
                        hwPowerOn(MT6331_POWER_LDO_VMC, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

                pr_notice("hwPowerDown(MT6331_POWER_LDO_VMC]\n");
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_rg_vmc_srclk_en_sel(0)]\n");
                         mt6331_upmu_set_rg_vmc_srclk_en_sel(0); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vmc_srclk_en_sel(1)]\n");
                         mt6331_upmu_set_rg_vmc_srclk_en_sel(1); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vmc_srclk_en_sel(2)]\n");
                         mt6331_upmu_set_rg_vmc_srclk_en_sel(2); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vmc_srclk_en_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vmc_on_ctrl(0);\n"); mt6331_upmu_set_rg_vmc_on_ctrl(0);
}
...
void exec_6331_ldo_vmch_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vmch_on_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vmch_on_ctrl(i);

        switch(i){
            case 0:
                pr_notice("hwPowerOn(MT6331_POWER_LDO_VMCH]\n");
                        hwPowerOn(MT6331_POWER_LDO_VMCH, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

                pr_notice("hwPowerDown(MT6331_POWER_LDO_VMCH]\n");
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_rg_vmch_srclk_en_sel(0)]\n");
                         mt6331_upmu_set_rg_vmch_srclk_en_sel(0); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vmch_srclk_en_sel(1)]\n");
                         mt6331_upmu_set_rg_vmch_srclk_en_sel(1); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vmch_srclk_en_sel(2)]\n");
                         mt6331_upmu_set_rg_vmch_srclk_en_sel(2); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vmch_srclk_en_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vmch_on_ctrl(0);\n"); mt6331_upmu_set_rg_vmch_on_ctrl(0);
}
...
void exec_6331_ldo_vemc33_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vemc33_on_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vemc33_on_ctrl(i);

        switch(i){
            case 0:
                pr_notice("hwPowerOn(MT6331_POWER_LDO_VEMC33]\n");
                        hwPowerOn(MT6331_POWER_LDO_VEMC33, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

                pr_notice("hwPowerDown(MT6331_POWER_LDO_VEMC33]\n");
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_rg_vemc33_srclk_en_sel(0)]\n");
                         mt6331_upmu_set_rg_vemc33_srclk_en_sel(0); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vemc33_srclk_en_sel(1)]\n");
                         mt6331_upmu_set_rg_vemc33_srclk_en_sel(1); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vemc33_srclk_en_sel(2)]\n");
                         mt6331_upmu_set_rg_vemc33_srclk_en_sel(2); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vemc33_srclk_en_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vemc33_on_ctrl(0);\n"); mt6331_upmu_set_rg_vemc33_on_ctrl(0);
}

void exec_6331_ldo_vgp1_en_test(void)
{
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP1]\n");
            hwPowerOn(MT6331_POWER_LDO_VGP1, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerDown(MT6331_POWER_LDO_VGP1]\n");
...
{
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP4]\n");
            hwPowerOn(MT6331_POWER_LDO_VGP4, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerDown(MT6331_POWER_LDO_VGP4]\n");
...
void exec_6331_ldo_vsim1_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vsim1_on_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vsim1_on_ctrl(i);

        switch(i){
            case 0:
                pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM1]\n");
                        hwPowerOn(MT6331_POWER_LDO_VSIM1, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

                pr_notice("hwPowerDown(MT6331_POWER_LDO_VSIM1]\n");
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_rg_vsim1_srclk_en_sel(0)]\n");
                         mt6331_upmu_set_rg_vsim1_srclk_en_sel(0); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vsim1_srclk_en_sel(1)]\n");
                         mt6331_upmu_set_rg_vsim1_srclk_en_sel(1); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vsim1_srclk_en_sel(2)]\n");
                         mt6331_upmu_set_rg_vsim1_srclk_en_sel(2); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vsim1_srclk_en_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vsim1_on_ctrl(0);\n"); mt6331_upmu_set_rg_vsim1_on_ctrl(0);
}
...
void exec_6331_ldo_vsim2_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vsim2_on_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vsim2_on_ctrl(i);

        switch(i){
            case 0:
                pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM2]\n");
                        hwPowerOn(MT6331_POWER_LDO_VSIM2, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

                pr_notice("hwPowerDown(MT6331_POWER_LDO_VSIM2]\n");
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_rg_vsim2_srclk_en_sel(0)]\n");
                         mt6331_upmu_set_rg_vsim2_srclk_en_sel(0); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vsim2_srclk_en_sel(1)]\n");
                         mt6331_upmu_set_rg_vsim2_srclk_en_sel(1); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vsim2_srclk_en_sel(2)]\n");
                         mt6331_upmu_set_rg_vsim2_srclk_en_sel(2); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vsim2_srclk_en_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vsim2_on_ctrl(0);\n"); mt6331_upmu_set_rg_vsim2_on_ctrl(0);
}

void exec_6331_ldo_vfbb_en_test(void)
{
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VFBB]\n");
            hwPowerOn(MT6331_POWER_LDO_VFBB, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerDown(MT6331_POWER_LDO_VFBB]\n");
...
{
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VIBR]\n");
            hwPowerOn(MT6331_POWER_LDO_VIBR, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerDown(MT6331_POWER_LDO_VIBR]\n");
...
void exec_6331_ldo_vrtc_en_test(void)
{
    ...
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VRTC]\n");
            hwPowerOn(MT6331_POWER_LDO_VRTC, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerDown(MT6331_POWER_LDO_VRTC]\n");
...
{
    pr_notice("exec_6331_ldo_vdig18_en_test : HW no en bit\n");
}
...
void exec_6331_ldo_vmipi_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vmipi_on_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vmipi_on_ctrl(i);

        switch(i){
            case 0:
                pr_notice("hwPowerOn(MT6331_POWER_LDO_VMIPI\n");
                        hwPowerOn(MT6331_POWER_LDO_VMIPI, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

                pr_notice("hwPowerDown(MT6331_POWER_LDO_VMIPI]\n");
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_rg_vmipi_srclk_en_sel(0)]\n");
                         mt6331_upmu_set_rg_vmipi_srclk_en_sel(0); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vmipi_srclk_en_sel(1)]\n");
                         mt6331_upmu_set_rg_vmipi_srclk_en_sel(1); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vmipi_srclk_en_sel(2)]\n");
                         mt6331_upmu_set_rg_vmipi_srclk_en_sel(2); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vmipi_srclk_en_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vmipi_on_ctrl(0);\n"); mt6331_upmu_set_rg_vmipi_on_ctrl(0);
}

void exec_6331_ldo_vcamd_en_test(void)
{
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VCAMD]\n");
            hwPowerOn(MT6331_POWER_LDO_VCAMD, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerDown(MT6331_POWER_LDO_VCAMD]\n");
...
{
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VUSB10]\n");
            hwPowerOn(MT6331_POWER_LDO_VUSB10, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerDown(MT6331_POWER_LDO_VUSB10]\n");
...
{
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VCAM_IO]\n");
            hwPowerOn(MT6331_POWER_LDO_VCAM_IO, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerDown(MT6331_POWER_LDO_VCAM_IO]\n");
...
void exec_6331_ldo_vsram_dvfs1_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vsram_dvfs1_on_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vsram_dvfs1_on_ctrl(i);

        switch(i){
            case 0:
                pr_notice("hwPowerOn(MT6331_POWER_LDO_VSRAM_DVFS1]\n");
                        hwPowerOn(MT6331_POWER_LDO_VSRAM_DVFS1, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

                pr_notice("hwPowerDown(MT6331_POWER_LDO_VSRAM_DVFS1]\n");
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_rg_vsram_dvfs1_srclk_en_sel(0)]\n");
                         mt6331_upmu_set_rg_vsram_dvfs1_srclk_en_sel(0); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vsram_dvfs1_srclk_en_sel(1)]\n");
                         mt6331_upmu_set_rg_vsram_dvfs1_srclk_en_sel(1); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vsram_dvfs1_srclk_en_sel(2)]\n");
                         mt6331_upmu_set_rg_vsram_dvfs1_srclk_en_sel(2); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6331_upmu_set_rg_vsram_dvfs1_srclk_en_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vsram_dvfs1_on_ctrl(0);\n"); mt6331_upmu_set_rg_vsram_dvfs1_on_ctrl(0);
}

void exec_6331_ldo_vgp2_en_test(void)
{
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP2]\n");
            hwPowerOn(MT6331_POWER_LDO_VGP2, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerDown(MT6331_POWER_LDO_VGP2]\n");
...
{
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP3]\n");
            hwPowerOn(MT6331_POWER_LDO_VGP3, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerDown(MT6331_POWER_LDO_VGP3]\n");
...
{
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VBIASN]\n");
            hwPowerOn(MT6331_POWER_LDO_VBIASN, VOL_0500, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerDown(MT6331_POWER_LDO_VBIASN]\n");
...
void exec_6332_ldo_vauxb32_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_rg_vauxb32_on_ctrl] %d\n", i);
        mt6332_upmu_set_rg_vauxb32_on_ctrl(i);

        switch(i){
            case 0:
                pr_notice("hwPowerOn(MT6332_POWER_LDO_VAUXB32]\n");
                        hwPowerOn(MT6332_POWER_LDO_VAUXB32, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

                pr_notice("hwPowerDown(MT6332_POWER_LDO_VAUXB32]\n");
            ...
            case 1:
                pr_notice("[mt6332_upmu_set_rg_vauxb32_srclk_en_sel(0)]\n");
                         mt6332_upmu_set_rg_vauxb32_srclk_en_sel(0); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6332_upmu_set_rg_vauxb32_srclk_en_sel(1)]\n");
                         mt6332_upmu_set_rg_vauxb32_srclk_en_sel(1); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6332_upmu_set_rg_vauxb32_srclk_en_sel(2)]\n");
                         mt6332_upmu_set_rg_vauxb32_srclk_en_sel(2); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6332_upmu_set_rg_vauxb32_srclk_en_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6332_upmu_set_rg_vauxb32_on_ctrl(0);\n"); mt6332_upmu_set_rg_vauxb32_on_ctrl(0);
}
...
void exec_6332_ldo_vbif28_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_rg_vbif28_on_ctrl] %d\n", i);
        mt6332_upmu_set_rg_vbif28_on_ctrl(i);

        switch(i){
            case 0:
                pr_notice("hwPowerOn(MT6332_POWER_LDO_VBIF28]\n");
                        hwPowerOn(MT6332_POWER_LDO_VBIF28, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

                pr_notice("hwPowerDown(MT6332_POWER_LDO_VBIF28]\n");
            ...
            case 1:
                pr_notice("[mt6332_upmu_set_rg_vbif28_srclk_en_sel(0)]\n");
                         mt6332_upmu_set_rg_vbif28_srclk_en_sel(0); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6332_upmu_set_rg_vbif28_srclk_en_sel(1)]\n");
                         mt6332_upmu_set_rg_vbif28_srclk_en_sel(1); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6332_upmu_set_rg_vbif28_srclk_en_sel(2)]\n");
                         mt6332_upmu_set_rg_vbif28_srclk_en_sel(2); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6332_upmu_set_rg_vbif28_srclk_en_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6332_upmu_set_rg_vbif28_on_ctrl(0);\n"); mt6332_upmu_set_rg_vbif28_on_ctrl(0);
}

void exec_6332_ldo_vusb33_en_test(void)
{
    pr_notice("hwPowerOn(MT6332_POWER_LDO_VUSB33]\n");
            hwPowerOn(MT6332_POWER_LDO_VUSB33, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerDown(MT6332_POWER_LDO_VUSB33]\n");
...
{
    pr_notice("exec_6332_ldo_vdig18_en_test : HW no en bit\n");
}
...
void exec_6332_ldo_vsram_dvfs2_en_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_rg_vsram_dvfs2_on_ctrl] %d\n", i);
        mt6332_upmu_set_rg_vsram_dvfs2_on_ctrl(i);

        switch(i){
            case 0:
                pr_notice("hwPowerOn(MT6332_POWER_LDO_VSRAM_DVFS2]\n");
                        hwPowerOn(MT6332_POWER_LDO_VSRAM_DVFS2, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);

                pr_notice("hwPowerDown(MT6332_POWER_LDO_VSRAM_DVFS2]\n");
            ...
            case 1:
                pr_notice("[mt6332_upmu_set_rg_vsram_dvfs2_srclk_en_sel(0)]\n");
                         mt6332_upmu_set_rg_vsram_dvfs2_srclk_en_sel(0); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6332_upmu_set_rg_vsram_dvfs2_srclk_en_sel(1)]\n");
                         mt6332_upmu_set_rg_vsram_dvfs2_srclk_en_sel(1); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6332_upmu_set_rg_vsram_dvfs2_srclk_en_sel(2)]\n");
                         mt6332_upmu_set_rg_vsram_dvfs2_srclk_en_sel(2); exec_scrxxx_map(LDO_ONLY);

                pr_notice("[mt6332_upmu_set_rg_vsram_dvfs2_srclk_en_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6332_upmu_set_rg_vsram_dvfs2_on_ctrl(0);\n"); mt6332_upmu_set_rg_vsram_dvfs2_on_ctrl(0);
}
#endif
...
void exec_6331_ldo_vtcxo1_vosel_test(void)
{
    ...
    mt6331_upmu_set_rg_vtcxo1_on_ctrl(0);
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VTCXO1] 2800\n");
    ...
    for(i=0;i<=3;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vtcxo1_vosel=%d\n", i);
...
void exec_6331_ldo_vtcxo2_vosel_test(void)
{
    ...
    mt6331_upmu_set_rg_vtcxo2_on_ctrl(0);
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VTCXO2] 2800\n");
    ...
    for(i=0;i<=3;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vtcxo2_vosel=%d\n", i);
...
void exec_6331_ldo_vaud32_vosel_test(void)
{
    ...
    mt6331_upmu_set_rg_vaud32_on_ctrl(0);
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VAUD32] VOL_2800\n");
    ...
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VAUD32] VOL_3000\n");
            hwPowerOn(MT6331_POWER_LDO_VAUD32, VOL_3000, "ldo_dvt"); read_adc_value(ADC_ONLY);
    pr_notice("hwPowerDown(MT6331_POWER_LDO_VAUD32]\n");
            hwPowerDown(MT6331_POWER_LDO_VAUD32, "ldo_dvt"); read_adc_value(ADC_ONLY);

    pr_notice("hwPowerOn(MT6331_POWER_LDO_VAUD32] VOL_3200\n");
    ...
    for(i=0;i<=3;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vaud32_vosel=%d\n", i);
...
void exec_6331_ldo_vauxa32_vosel_test(void)
{
    ...
    mt6331_upmu_set_rg_vauxa32_on_ctrl(0);
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VAUXA32] VOL_2800\n");
    ...
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VAUXA32] VOL_3000\n");
            hwPowerOn(MT6331_POWER_LDO_VAUXA32, VOL_3000, "ldo_dvt"); read_adc_value(ADC_ONLY);
    pr_notice("hwPowerDown(MT6331_POWER_LDO_VAUXA32]\n");
            hwPowerDown(MT6331_POWER_LDO_VAUXA32, "ldo_dvt"); read_adc_value(ADC_ONLY);

    pr_notice("hwPowerOn(MT6331_POWER_LDO_VAUXA32] VOL_3200\n");
    ...
    for(i=0;i<=3;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vauxa32_vosel=%d\n", i);
...
void exec_6331_ldo_vcama_vosel_test(void)
{
    int i=0;
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VCAMA] VOL_1500\n");
    ...
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VCAMA] VOL_1800\n");
            hwPowerOn(MT6331_POWER_LDO_VCAMA, VOL_1800, "ldo_dvt"); read_adc_value(ADC_ONLY);
    pr_notice("hwPowerDown(MT6331_POWER_LDO_VCAMA]\n");
            hwPowerDown(MT6331_POWER_LDO_VCAMA, "ldo_dvt"); read_adc_value(ADC_ONLY);

    pr_notice("hwPowerOn(MT6331_POWER_LDO_VCAMA] VOL_2500\n");
            hwPowerOn(MT6331_POWER_LDO_VCAMA, VOL_2500, "ldo_dvt"); read_adc_value(ADC_ONLY);
    pr_notice("hwPowerDown(MT6331_POWER_LDO_VCAMA]\n");
            hwPowerDown(MT6331_POWER_LDO_VCAMA, "ldo_dvt"); read_adc_value(ADC_ONLY);

    pr_notice("hwPowerOn(MT6331_POWER_LDO_VCAMA] VOL_2800\n");
    ...
    for(i=0;i<=7;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vcama_vosel=%d\n", i);
...
void exec_6331_ldo_vio28_vosel_test(void)
{
    int i=0;
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VIO28] VOL_DEFAULT\n");
    ...
    for(i=0;i<=7;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vio28_vosel=%d\n", i);
...
{
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VCAM_AF] VOL_1200\n");
...
void exec_6331_ldo_vmc_vosel_test(void)
{
    ...
    mt6331_upmu_set_rg_vmc_on_ctrl(0);
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VMC] VOL_1800\n");
    ...
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VMC] VOL_3300\n");
    ...
    for(i=0;i<=7;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vmc_vosel=%d\n", i);
...
void exec_6331_ldo_vmch_vosel_test(void)
{
    ...
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VMCH] VOL_3000\n");
            hwPowerOn(MT6331_POWER_LDO_VMCH, VOL_3000, "ldo_dvt"); read_adc_value(LDO_ONLY);
    pr_notice("hwPowerDown(MT6331_POWER_LDO_VMCH]\n");
            hwPowerDown(MT6331_POWER_LDO_VMCH, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerOn(MT6331_POWER_LDO_VMCH] VOL_3300\n");
...
void exec_6331_ldo_vemc33_vosel_test(void)
{
    ...
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VEMC33] VOL_3000\n");
            hwPowerOn(MT6331_POWER_LDO_VEMC33, VOL_3000, "ldo_dvt"); read_adc_value(LDO_ONLY);
    pr_notice("hwPowerDown(MT6331_POWER_LDO_VEMC33]\n");
            hwPowerDown(MT6331_POWER_LDO_VEMC33, "ldo_dvt"); read_adc_value(LDO_ONLY);

    pr_notice("hwPowerOn(MT6331_POWER_LDO_VEMC33] VOL_3300\n");
...
{
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP1] VOL_1200\n");
...
void exec_6331_ldo_vgp4_vosel_test(void)
{
    ...
    {
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP4] MT6331==E1\n");

        //---------------------------------------------------------------------------
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP4] VOL_1200\n");
    ...
    {
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP4] MT6331>=E2\n");
        ...
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP4] VOL_1600\n");
                hwPowerOn(MT6331_POWER_LDO_VGP4, VOL_1600, "ldo_dvt"); read_adc_value(ADC_ONLY);
        pr_notice("hwPowerDown(MT6331_POWER_LDO_VGP4]\n");
                hwPowerDown(MT6331_POWER_LDO_VGP4, "ldo_dvt"); read_adc_value(ADC_ONLY);

        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP4] VOL_1700\n");
        ...
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP4] VOL_1900\n");
        ...
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP4] VOL_2100\n");
                hwPowerOn(MT6331_POWER_LDO_VGP4, VOL_2100, "ldo_dvt"); read_adc_value(ADC_ONLY);
        pr_notice("hwPowerDown(MT6331_POWER_LDO_VGP4]\n");
                hwPowerDown(MT6331_POWER_LDO_VGP4, "ldo_dvt"); read_adc_value(ADC_ONLY);

        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP4] VOL_2200\n");
...
void exec_6331_ldo_vsim1_vosel_test(void)
{
    ...
    if(get_pmic_mt6331_cid()==PMIC6331_E1_CID_CODE)
    {
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM1] MT6331==E1\n");

        //---------------------------------------------------------------------------
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM1] VOL_1800\n");
        ...
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM1] VOL_3000\n");
    ...
    {
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM1] MT6331>=E2\n");

        //---------------------------------------------------------------------------
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM1] VOL_1700\n");
        ...
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM1] VOL_1860\n");
                hwPowerOn(MT6331_POWER_LDO_VSIM1, VOL_1860, "ldo_dvt"); read_adc_value(ADC_ONLY);
        pr_notice("hwPowerDown(MT6331_POWER_LDO_VSIM1]\n");
                hwPowerDown(MT6331_POWER_LDO_VSIM1, "ldo_dvt"); read_adc_value(ADC_ONLY);

        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM1] VOL_2760\n");
        ...
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM1] VOL_3100\n");
    ...
    for(i=0;i<=7;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vsim1_vosel=%d\n", i);
...
void exec_6331_ldo_vsim2_vosel_test(void)
{
    ...
    if(get_pmic_mt6331_cid()==PMIC6331_E1_CID_CODE)
    {
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM2] MT6331==E1\n");

        //---------------------------------------------------------------------------
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM2] VOL_1800\n");
        ...
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM2] VOL_3000\n");
    ...
    {
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM2] MT6331>=E2\n");

        //---------------------------------------------------------------------------
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM2] VOL_1700\n");
        ...
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM2] VOL_1860\n");
                hwPowerOn(MT6331_POWER_LDO_VSIM2, VOL_1860, "ldo_dvt"); read_adc_value(ADC_ONLY);
        pr_notice("hwPowerDown(MT6331_POWER_LDO_VSIM2]\n");
                hwPowerDown(MT6331_POWER_LDO_VSIM2, "ldo_dvt"); read_adc_value(ADC_ONLY);

        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM2] VOL_2760\n");
        ...
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VSIM2] VOL_3100\n");
    ...
    for(i=0;i<=7;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vsim2_vosel=%d\n", i);
...
void exec_6331_ldo_vfbb_vosel_test(void)
{
    ...
    for(i=0;i<=7;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vfbb_vosel=%d\n", i);
...
{
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VIBR] VOL_1200\n");
...
{
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VRTC] VOL_DEFAULT\n");
            hwPowerOn(MT6331_POWER_LDO_VRTC, VOL_DEFAULT, "ldo_dvt"); read_adc_value(LDO_ONLY);
    pr_notice("hwPowerDown(MT6331_POWER_LDO_VRTC]\n");
            hwPowerDown(MT6331_POWER_LDO_VRTC, "ldo_dvt"); read_adc_value(LDO_ONLY);
}
...
void exec_6331_vdig18_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6331_PMIC_RG_VDIG18_VOSEL_MASK;k++) {
        mt6331_upmu_set_rg_vdig18_vosel(k); pr_notice("[mt6331_upmu_set_rg_vdig18_vosel] k=%d, ",k);
        read_adc_value(LDO_ONLY);
    }
    for(k=0;k<=MT6331_PMIC_RG_VDIG18_SLEEP_VOSEL_MASK;k++) {
        mt6331_upmu_set_rg_vdig18_sleep_vosel(k); pr_notice("[mt6331_upmu_set_rg_vdig18_sleep_vosel] k=%d, ",k);
        read_adc_value(LDO_ONLY);
    }
}
...
{
    pr_notice("[exec_6331_vdig18_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_6331_vdig18_vosel_test_sub_vosel();

    pr_notice("[exec_6331_vdig18_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_6331_vdig18_vosel_test_sub_vosel();

    pr_notice("[exec_6331_vdig18_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_6331_vdig18_vosel_test_sub_vosel();

    pr_notice("[exec_6331_vdig18_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_6331_ldo_vdig18_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vdig18_vosel_ctrl] %d\n", i);
        ...
        switch(i){
            ...
            case 1:
                pr_notice("[mt6331_upmu_set_rg_vdig18_srclken_sel(0)]\n");
                mt6331_upmu_set_rg_vdig18_srclken_sel(0);
                exec_6331_vdig18_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vdig18_srclken_sel(1)]\n");
                mt6331_upmu_set_rg_vdig18_srclken_sel(1);
                exec_6331_vdig18_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vdig18_srclken_sel(2)]\n");
                mt6331_upmu_set_rg_vdig18_srclken_sel(2);
                exec_6331_vdig18_vosel_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vdig18_srclken_sel(3)]\n");
...
void exec_6331_ldo_vmipi_vosel_test(void)
{
    ...
    mt6331_upmu_set_rg_vmipi_on_ctrl(0);
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VMIPI] VOL_1200\n");
    ...
    for(i=0;i<=15;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vmipi_vosel=%d\n", i);
...
void exec_6331_ldo_vcamd_vosel_test(void)
{
    ...
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VCAMD] VOL_0900\n");
    ...
    for(i=0;i<=7;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vcamd_vosel=%d\n", i);
...
void exec_6331_ldo_vusb10_vosel_test(void)
{
    ...
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VUSB10] VOL_1000\n");
    ...
    for(i=0;i<=15;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vusb10_vosel=%d\n", i);
...
void exec_6331_ldo_vcam_io_vosel_test(void)
{
    ...
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VCAM_IO] VOL_1200\n");
    ...
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VCAM_IO] VOL_1300\n");
            hwPowerOn(MT6331_POWER_LDO_VCAM_IO, VOL_1300, "ldo_dvt"); read_adc_value(ADC_ONLY);
    pr_notice("hwPowerDown(MT6331_POWER_LDO_VCAM_IO]\n");
            hwPowerDown(MT6331_POWER_LDO_VCAM_IO, "ldo_dvt"); read_adc_value(ADC_ONLY);

    pr_notice("hwPowerOn(MT6331_POWER_LDO_VCAM_IO] VOL_1500\n");
            hwPowerOn(MT6331_POWER_LDO_VCAM_IO, VOL_1500, "ldo_dvt"); read_adc_value(ADC_ONLY);
    pr_notice("hwPowerDown(MT6331_POWER_LDO_VCAM_IO]\n");
            hwPowerDown(MT6331_POWER_LDO_VCAM_IO, "ldo_dvt"); read_adc_value(ADC_ONLY);

    pr_notice("hwPowerOn(MT6331_POWER_LDO_VCAM_IO] VOL_1800\n");
    ...
    for(i=0;i<=15;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vcam_io_vosel=%d\n", i);
...
void exec_6331_ldo_vsram_dvfs1_vosel_test(void)
{
    ...
    for(i=0;i<=0x7F;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vsram_dvfs1_vosel=%d\n", i);
...
void exec_6331_ldo_vgp2_vosel_test(void)
{
    ...
    if(get_pmic_mt6331_cid()==PMIC6331_E1_CID_CODE)
    {
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP2] MT6331==E1\n");

        //---------------------------------------------------------------------------
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP2] VOL_1200\n");
        ...
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP2] VOL_1300\n");
                hwPowerOn(MT6331_POWER_LDO_VGP2, VOL_1300, "ldo_dvt"); read_adc_value(ADC_ONLY);
        pr_notice("hwPowerDown(MT6331_POWER_LDO_VGP2]\n");
                hwPowerDown(MT6331_POWER_LDO_VGP2, "ldo_dvt"); read_adc_value(ADC_ONLY);

        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP2] VOL_1500\n");
                hwPowerOn(MT6331_POWER_LDO_VGP2, VOL_1500, "ldo_dvt"); read_adc_value(ADC_ONLY);
        pr_notice("hwPowerDown(MT6331_POWER_LDO_VGP2]\n");
                hwPowerDown(MT6331_POWER_LDO_VGP2, "ldo_dvt"); read_adc_value(ADC_ONLY);

        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP2] VOL_1800\n");
    ...
    {
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP2] MT6331>=E2\n");
        ...
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP2] VOL_1360\n");
        ...
        pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP2] VOL_1100\n");
    ...
    for(i=0;i<=15;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vgp2_vosel=%d\n", i);
...
void exec_6331_ldo_vgp3_vosel_test(void)
{
    ...
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP3] VOL_1200\n");
    ...
    pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP3] VOL_1300\n");
            hwPowerOn(MT6331_POWER_LDO_VGP3, VOL_1300, "ldo_dvt"); read_adc_value(ADC_ONLY);
    pr_notice("hwPowerDown(MT6331_POWER_LDO_VGP3]\n");
            hwPowerDown(MT6331_POWER_LDO_VGP3, "ldo_dvt"); read_adc_value(ADC_ONLY);

    pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP3] VOL_1500\n");
            hwPowerOn(MT6331_POWER_LDO_VGP3, VOL_1500, "ldo_dvt"); read_adc_value(ADC_ONLY);
    pr_notice("hwPowerDown(MT6331_POWER_LDO_VGP3]\n");
            hwPowerDown(MT6331_POWER_LDO_VGP3, "ldo_dvt"); read_adc_value(ADC_ONLY);

    pr_notice("hwPowerOn(MT6331_POWER_LDO_VGP3] VOL_1800\n");
    ...
    for(i=0;i<=15;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vgp3_vosel=%d\n", i);
...
void exec_6331_ldo_vbiasn_vosel_test(void)
{
    ...
    for(i=0;i<=31;i++)
    {
        pr_notice("mt6331_upmu_set_rg_vbiasn_vosel=%d\n", i);
...
void exec_6332_ldo_vauxb32_vosel_test(void)
{
    ...
    mt6332_upmu_set_rg_vauxb32_on_ctrl(0);
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6332_POWER_LDO_VAUXB32] VOL_2800\n");
    ...
    pr_notice("hwPowerOn(MT6332_POWER_LDO_VAUXB32] VOL_3000\n");
            hwPowerOn(MT6332_POWER_LDO_VAUXB32, VOL_3000, "ldo_dvt"); read_adc_value(ADC_ONLY);
    pr_notice("hwPowerDown(MT6332_POWER_LDO_VAUXB32]\n");
            hwPowerDown(MT6332_POWER_LDO_VAUXB32, "ldo_dvt"); read_adc_value(ADC_ONLY);

    pr_notice("hwPowerOn(MT6332_POWER_LDO_VAUXB32] VOL_3200\n");
    ...
    for(i=0;i<=3;i++)
    {
        pr_notice("mt6332_upmu_set_rg_vauxb32_vosel=%d\n", i);
...
void exec_6332_ldo_vbif28_vosel_test(void)
{
    mt6332_upmu_set_rg_vbif28_on_ctrl(0);
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6332_POWER_LDO_VBIF28] VOL_DEFAULT\n");
...
{
    //---------------------------------------------------------------------------
    pr_notice("hwPowerOn(MT6332_POWER_LDO_VUSB33] VOL_DEFAULT\n");
...
void exec_6332_vdig18_vosel_test_sub_vosel(void)
{
    ...
    for(k=0;k<=MT6332_PMIC_RG_VDIG18_VOSEL_MASK;k++) {
        mt6332_upmu_set_rg_vdig18_vosel(k); pr_notice("[mt6332_upmu_set_rg_vdig18_vosel] k=%d, ",k);
        read_adc_value(LDO_ONLY);
    }
    for(k=0;k<=MT6332_PMIC_RG_VDIG18_SLEEP_VOSEL_MASK;k++) {
        mt6332_upmu_set_rg_vdig18_sleep_vosel(k); pr_notice("[mt6332_upmu_set_rg_vdig18_sleep_vosel] k=%d, ",k);
        read_adc_value(LDO_ONLY);
    }
}
...
{
    pr_notice("[exec_6332_vdig18_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(0);\n");
                              set_srclken_1_val(0); set_srclken_2_val(0); exec_6332_vdig18_vosel_test_sub_vosel();

    pr_notice("[exec_6332_vdig18_vosel_test_sub] set_srclken_1_val(0); set_srclken_2_val(1);\n");
                              set_srclken_1_val(0); set_srclken_2_val(1); exec_6332_vdig18_vosel_test_sub_vosel();

    pr_notice("[exec_6332_vdig18_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(0);\n");
                              set_srclken_1_val(1); set_srclken_2_val(0); exec_6332_vdig18_vosel_test_sub_vosel();

    pr_notice("[exec_6332_vdig18_vosel_test_sub] set_srclken_1_val(1); set_srclken_2_val(1);\n");
...
void exec_6332_ldo_vdig18_vosel_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_rg_vdig18_vosel_ctrl] %d\n", i);
        ...
        switch(i){
            ...
            case 1:
                pr_notice("[mt6332_upmu_set_rg_vdig18_srclken_sel(0)]\n");
                mt6332_upmu_set_rg_vdig18_srclken_sel(0);
                exec_6332_vdig18_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_rg_vdig18_srclken_sel(1)]\n");
                mt6332_upmu_set_rg_vdig18_srclken_sel(1);
                exec_6332_vdig18_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_rg_vdig18_srclken_sel(2)]\n");
                mt6332_upmu_set_rg_vdig18_srclken_sel(2);
                exec_6332_vdig18_vosel_test_sub();

                pr_notice("[mt6332_upmu_set_rg_vdig18_srclken_sel(3)]\n");
...
void exec_6332_ldo_vsram_dvfs2_vosel_test(void)
{
    ...
    //for(i=0x32;i<=0x7F;i++)
    {
        pr_notice("mt6332_upmu_set_rg_vsram_dvfs2_vosel=%d\n", i);
...
void exec_6331_ldo_vtcxo1_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vtcxo1_cal=%d, ", i);
...
void exec_6331_ldo_vtcxo2_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vtcxo2_cal=%d, ", i);
...
void exec_6331_ldo_vauxa32_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vauxa32_cal=%d, ", i);
...
void exec_6331_ldo_vaud32_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vaud32_cal=%d, ", i);
...
void exec_6331_ldo_vcama_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vcama_cal=%d, ", i);
...
void exec_6331_ldo_vio28_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vio28_cal=%d, ", i);
...
void exec_6331_ldo_vcam_af_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vcam_af_cal=%d, ", i);
...
void exec_6331_ldo_vmc_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vmc_cal=%d, ", i);
...
void exec_6331_ldo_vmch_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vmch_cal=%d, ", i);
...
void exec_6331_ldo_vemc33_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vemc33_cal=%d, ", i);
...
void exec_6331_ldo_vgp1_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vgp1_cal=%d, ", i);
...
void exec_6331_ldo_vgp4_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vgp4_cal=%d, ", i);
...
void exec_6331_ldo_vsim1_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vsim1_cal=%d, ", i);
...
void exec_6331_ldo_vsim2_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vsim2_cal=%d, ", i);
...
void exec_6331_ldo_vibr_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vibr_cal=%d, ", i);
...
void exec_6331_ldo_vcamd_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vcamd_cal=%d, ", i);
...
void exec_6331_ldo_vusb10_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vusb10_cal=%d, ", i);
...
void exec_6331_ldo_vcam_io_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vcam_io_cal=%d, ", i);
...
void exec_6331_ldo_vgp2_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vgp2_cal=%d, ", i);
...
void exec_6331_ldo_vgp3_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vgp3_cal=%d, ", i);
...
void exec_6331_ldo_vbiasn_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vbiasn_cal=%d, ", i);
...
void exec_6331_ldo_vmipi_cal_test(void)
{
    ...
    {
        pr_notice("mt6331_upmu_set_rg_vmipi_cal=%d, ", i);
...
{
    pr_notice("no exec_6331_ldo_vsram_dvfs1_cal_test\n");
}

void exec_6331_ldo_vfbb_cal_test(void)
{
    pr_notice("no exec_6331_ldo_vfbb_cal_test\n");
}

void exec_6331_ldo_vrtc_cal_test(void)
{
    pr_notice("no exec_6331_ldo_vrtc_cal_test\n");
}

void exec_6331_ldo_vdig18_cal_test(void)
{
    pr_notice("no exec_6331_ldo_vdig18_cal_test\n");
}
...
void exec_6332_ldo_vauxb32_cal_test(void)
{
    ...
    {
        pr_notice("mt6332_upmu_set_rg_vauxb32_cal=%d, ", i);
...
void exec_6332_ldo_vusb33_cal_test(void)
{
    ...
    {
        pr_notice("mt6332_upmu_set_rg_vusb33_cal=%d, ", i);
...
void exec_6332_ldo_vbif28_cal_test(void)
{
    ...
    {
        pr_notice("mt6332_upmu_set_rg_vbif28_cal=%d, ", i);
...
{
    pr_notice("no exec_6332_ldo_vsram_dvfs2_cal_test\n");
}

void exec_6332_ldo_vdig18_cal_test(void)
{
    pr_notice("no exec_6332_ldo_vdig18_cal_test\n");
}
#endif
...
void exec_6331_ldo_vtcxo1_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vtcxo1_mode = %d\n", mt6331_upmu_get_qi_vtcxo1_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vtcxo1_mode = %d\n", mt6331_upmu_get_qi_vtcxo1_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vtcxo1_mode = %d\n", mt6331_upmu_get_qi_vtcxo1_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(1);\n"); set_srclken_1_val(1); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vtcxo1_mode = %d\n", mt6331_upmu_get_qi_vtcxo1_mode());
}
...
void exec_6331_ldo_vtcxo1_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vtcxo1_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vtcxo1_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vtcxo1_lp_set(0);\n");
                        mt6331_upmu_set_rg_vtcxo1_lp_set(0);
                pr_notice("mt6331_upmu_get_qi_vtcxo1_mode = %d\n", mt6331_upmu_get_qi_vtcxo1_mode());

                pr_notice("mt6331_upmu_set_rg_vtcxo1_lp_set(1);\n");
                        mt6331_upmu_set_rg_vtcxo1_lp_set(1);
                pr_notice("mt6331_upmu_get_qi_vtcxo1_mode = %d\n", mt6331_upmu_get_qi_vtcxo1_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vtcxo1_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vtcxo1_srclk_mode_sel(0);
                exec_6331_ldo_vtcxo1_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vtcxo1_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vtcxo1_srclk_mode_sel(1);
                exec_6331_ldo_vtcxo1_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vtcxo1_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vtcxo1_srclk_mode_sel(2);
                exec_6331_ldo_vtcxo1_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vtcxo1_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vtcxo1_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vtcxo1_lp_ctrl(0);
}
...
void exec_6331_ldo_vtcxo2_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vtcxo2_mode = %d\n", mt6331_upmu_get_qi_vtcxo2_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vtcxo2_mode = %d\n", mt6331_upmu_get_qi_vtcxo2_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vtcxo2_mode = %d\n", mt6331_upmu_get_qi_vtcxo2_mode());
...
void exec_6331_ldo_vtcxo2_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vtcxo2_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vtcxo2_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vtcxo2_lp_set(0);\n");
                        mt6331_upmu_set_rg_vtcxo2_lp_set(0);
                pr_notice("mt6331_upmu_get_qi_vtcxo2_mode = %d\n", mt6331_upmu_get_qi_vtcxo2_mode());

                pr_notice("mt6331_upmu_set_rg_vtcxo2_lp_set(1);\n");
                        mt6331_upmu_set_rg_vtcxo2_lp_set(1);
                pr_notice("mt6331_upmu_get_qi_vtcxo2_mode = %d\n", mt6331_upmu_get_qi_vtcxo2_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vtcxo2_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vtcxo2_srclk_mode_sel(0);
                exec_6331_ldo_vtcxo2_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vtcxo2_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vtcxo2_srclk_mode_sel(1);
                exec_6331_ldo_vtcxo2_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vtcxo2_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vtcxo2_srclk_mode_sel(2);
                exec_6331_ldo_vtcxo2_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vtcxo2_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vtcxo2_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vtcxo2_lp_ctrl(0);
}
...
void exec_6331_ldo_vaud32_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vaud32_mode = %d\n", mt6331_upmu_get_qi_vaud32_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vaud32_mode = %d\n", mt6331_upmu_get_qi_vaud32_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vaud32_mode = %d\n", mt6331_upmu_get_qi_vaud32_mode());
...
void exec_6331_ldo_vaud32_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vaud32_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vaud32_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vaud32_lp_set(0);\n");
                        mt6331_upmu_set_rg_vaud32_lp_set(0);
                pr_notice("mt6331_upmu_get_qi_vaud32_mode = %d\n", mt6331_upmu_get_qi_vaud32_mode());

                pr_notice("mt6331_upmu_set_rg_vaud32_lp_set(1);\n");
                        mt6331_upmu_set_rg_vaud32_lp_set(1);
                pr_notice("mt6331_upmu_get_qi_vaud32_mode = %d\n", mt6331_upmu_get_qi_vaud32_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vaud32_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vaud32_srclk_mode_sel(0);
                exec_6331_ldo_vaud32_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vaud32_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vaud32_srclk_mode_sel(1);
                exec_6331_ldo_vaud32_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vaud32_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vaud32_srclk_mode_sel(2);
                exec_6331_ldo_vaud32_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vaud32_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vaud32_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vaud32_lp_ctrl(0);
}
...
void exec_6331_ldo_vauxa32_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vauxa32_mode = %d\n", mt6331_upmu_get_qi_vauxa32_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vauxa32_mode = %d\n", mt6331_upmu_get_qi_vauxa32_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vauxa32_mode = %d\n", mt6331_upmu_get_qi_vauxa32_mode());
...
void exec_6331_ldo_vauxa32_mode_test(void)
{
    ...
    pr_notice("mt6331_upmu_set_rg_vauxa32_auxadc_pwdb_en(1);\n");
            mt6331_upmu_set_rg_vauxa32_auxadc_pwdb_en(1);

    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vauxa32_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vauxa32_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vauxa32_lp_set(0);\n");
                        mt6331_upmu_set_rg_vauxa32_lp_set(0);
                pr_notice("mt6331_upmu_get_qi_vauxa32_mode = %d\n", mt6331_upmu_get_qi_vauxa32_mode());

                pr_notice("mt6331_upmu_set_rg_vauxa32_lp_set(1);\n");
                        mt6331_upmu_set_rg_vauxa32_lp_set(1);
                pr_notice("mt6331_upmu_get_qi_vauxa32_mode = %d\n", mt6331_upmu_get_qi_vauxa32_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vauxa32_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vauxa32_srclk_mode_sel(0);
                exec_6331_ldo_vauxa32_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vauxa32_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vauxa32_srclk_mode_sel(1);
                exec_6331_ldo_vauxa32_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vauxa32_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vauxa32_srclk_mode_sel(2);
                exec_6331_ldo_vauxa32_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vauxa32_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vauxa32_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vauxa32_lp_ctrl(0);
}

void exec_6331_ldo_vcama_mode_test(void)
{
    pr_notice("no exec_6331_ldo_vcama_mode_test\n");
}
...
void exec_6331_ldo_vio28_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vio28_mode = %d\n", mt6331_upmu_get_qi_vio28_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vio28_mode = %d\n", mt6331_upmu_get_qi_vio28_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vio28_mode = %d\n", mt6331_upmu_get_qi_vio28_mode());
...
void exec_6331_ldo_vio28_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vio28_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vio28_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vio28_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vio28_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vio28_mode = %d\n", mt6331_upmu_get_qi_vio28_mode());

                pr_notice("mt6331_upmu_set_rg_vio28_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vio28_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vio28_mode = %d\n", mt6331_upmu_get_qi_vio28_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vio28_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vio28_srclk_mode_sel(0);
                exec_6331_ldo_vio28_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vio28_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vio28_srclk_mode_sel(1);
                exec_6331_ldo_vio28_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vio28_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vio28_srclk_mode_sel(2);
                exec_6331_ldo_vio28_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vio28_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vio28_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vio28_lp_ctrl(0);
}
...
void exec_6331_ldo_vcam_af_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vcam_af_mode = %d\n", mt6331_upmu_get_qi_vcam_af_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vcam_af_mode = %d\n", mt6331_upmu_get_qi_vcam_af_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vcam_af_mode = %d\n", mt6331_upmu_get_qi_vcam_af_mode());
...
void exec_6331_ldo_vcam_af_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vcam_af_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vcam_af_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vcam_af_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vcam_af_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vcam_af_mode = %d\n", mt6331_upmu_get_qi_vcam_af_mode());

                pr_notice("mt6331_upmu_set_rg_vcam_af_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vcam_af_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vcam_af_mode = %d\n", mt6331_upmu_get_qi_vcam_af_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vcam_af_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vcam_af_srclk_mode_sel(0);
                exec_6331_ldo_vcam_af_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vcam_af_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vcam_af_srclk_mode_sel(1);
                exec_6331_ldo_vcam_af_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vcam_af_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vcam_af_srclk_mode_sel(2);
                exec_6331_ldo_vcam_af_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vcam_af_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vcam_af_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vcam_af_lp_ctrl(0);
}
...
void exec_6331_ldo_vmc_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vmc_mode = %d\n", mt6331_upmu_get_qi_vmc_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vmc_mode = %d\n", mt6331_upmu_get_qi_vmc_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vmc_mode = %d\n", mt6331_upmu_get_qi_vmc_mode());
...
void exec_6331_ldo_vmc_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vmc_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vmc_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vmc_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vmc_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vmc_mode = %d\n", mt6331_upmu_get_qi_vmc_mode());

                pr_notice("mt6331_upmu_set_rg_vmc_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vmc_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vmc_mode = %d\n", mt6331_upmu_get_qi_vmc_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vmc_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vmc_srclk_mode_sel(0);
                exec_6331_ldo_vmc_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vmc_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vmc_srclk_mode_sel(1);
                exec_6331_ldo_vmc_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vmc_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vmc_srclk_mode_sel(2);
                exec_6331_ldo_vmc_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vmc_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vmc_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vmc_lp_ctrl(0);
}
...
void exec_6331_ldo_vmch_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vmch_mode = %d\n", mt6331_upmu_get_qi_vmch_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vmch_mode = %d\n", mt6331_upmu_get_qi_vmch_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vmch_mode = %d\n", mt6331_upmu_get_qi_vmch_mode());
...
void exec_6331_ldo_vmch_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vmch_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vmch_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vmch_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vmch_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vmch_mode = %d\n", mt6331_upmu_get_qi_vmch_mode());

                pr_notice("mt6331_upmu_set_rg_vmch_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vmch_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vmch_mode = %d\n", mt6331_upmu_get_qi_vmch_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vmch_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vmch_srclk_mode_sel(0);
                exec_6331_ldo_vmch_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vmch_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vmch_srclk_mode_sel(1);
                exec_6331_ldo_vmch_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vmch_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vmch_srclk_mode_sel(2);
                exec_6331_ldo_vmch_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vmch_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vmch_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vmch_lp_ctrl(0);
}
...
void exec_6331_ldo_vemc33_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vemc33_mode = %d\n", mt6331_upmu_get_qi_vemc33_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vemc33_mode = %d\n", mt6331_upmu_get_qi_vemc33_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vemc33_mode = %d\n", mt6331_upmu_get_qi_vemc33_mode());
...
void exec_6331_ldo_vemc33_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vemc33_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vemc33_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vemc33_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vemc33_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vemc33_mode = %d\n", mt6331_upmu_get_qi_vemc33_mode());

                pr_notice("mt6331_upmu_set_rg_vemc33_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vemc33_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vemc33_mode = %d\n", mt6331_upmu_get_qi_vemc33_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vemc33_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vemc33_srclk_mode_sel(0);
                exec_6331_ldo_vemc33_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vemc33_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vemc33_srclk_mode_sel(1);
                exec_6331_ldo_vemc33_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vemc33_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vemc33_srclk_mode_sel(2);
                exec_6331_ldo_vemc33_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vemc33_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vemc33_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vemc33_lp_ctrl(0);
}
...
void exec_6331_ldo_vgp1_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vgp1_mode = %d\n", mt6331_upmu_get_qi_vgp1_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vgp1_mode = %d\n", mt6331_upmu_get_qi_vgp1_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vgp1_mode = %d\n", mt6331_upmu_get_qi_vgp1_mode());
...
void exec_6331_ldo_vgp1_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vgp1_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vgp1_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vgp1_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vgp1_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vgp1_mode = %d\n", mt6331_upmu_get_qi_vgp1_mode());

                pr_notice("mt6331_upmu_set_rg_vgp1_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vgp1_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vgp1_mode = %d\n", mt6331_upmu_get_qi_vgp1_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vgp1_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vgp1_srclk_mode_sel(0);
                exec_6331_ldo_vgp1_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vgp1_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vgp1_srclk_mode_sel(1);
                exec_6331_ldo_vgp1_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vgp1_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vgp1_srclk_mode_sel(2);
                exec_6331_ldo_vgp1_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vgp1_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vgp1_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vgp1_lp_ctrl(0);
}
...
void exec_6331_ldo_vgp4_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vgp4_mode = %d\n", mt6331_upmu_get_qi_vgp4_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vgp4_mode = %d\n", mt6331_upmu_get_qi_vgp4_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vgp4_mode = %d\n", mt6331_upmu_get_qi_vgp4_mode());
...
void exec_6331_ldo_vgp4_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vgp4_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vgp4_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vgp4_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vgp4_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vgp4_mode = %d\n", mt6331_upmu_get_qi_vgp4_mode());

                pr_notice("mt6331_upmu_set_rg_vgp4_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vgp4_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vgp4_mode = %d\n", mt6331_upmu_get_qi_vgp4_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vgp4_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vgp4_srclk_mode_sel(0);
                exec_6331_ldo_vgp4_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vgp4_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vgp4_srclk_mode_sel(1);
                exec_6331_ldo_vgp4_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vgp4_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vgp4_srclk_mode_sel(2);
                exec_6331_ldo_vgp4_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vgp4_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vgp4_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vgp4_lp_ctrl(0);
}
...
void exec_6331_ldo_vsim1_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vsim1_mode = %d\n", mt6331_upmu_get_qi_vsim1_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vsim1_mode = %d\n", mt6331_upmu_get_qi_vsim1_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vsim1_mode = %d\n", mt6331_upmu_get_qi_vsim1_mode());
...
void exec_6331_ldo_vsim1_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vsim1_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vsim1_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vsim1_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vsim1_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vsim1_mode = %d\n", mt6331_upmu_get_qi_vsim1_mode());

                pr_notice("mt6331_upmu_set_rg_vsim1_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vsim1_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vsim1_mode = %d\n", mt6331_upmu_get_qi_vsim1_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vsim1_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vsim1_srclk_mode_sel(0);
                exec_6331_ldo_vsim1_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vsim1_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vsim1_srclk_mode_sel(1);
                exec_6331_ldo_vsim1_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vsim1_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vsim1_srclk_mode_sel(2);
                exec_6331_ldo_vsim1_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vsim1_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vsim1_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vsim1_lp_ctrl(0);
}
...
void exec_6331_ldo_vsim2_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vsim2_mode = %d\n", mt6331_upmu_get_qi_vsim2_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vsim2_mode = %d\n", mt6331_upmu_get_qi_vsim2_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vsim2_mode = %d\n", mt6331_upmu_get_qi_vsim2_mode());
...
void exec_6331_ldo_vsim2_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vsim2_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vsim2_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vsim2_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vsim2_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vsim2_mode = %d\n", mt6331_upmu_get_qi_vsim2_mode());

                pr_notice("mt6331_upmu_set_rg_vsim2_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vsim2_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vsim2_mode = %d\n", mt6331_upmu_get_qi_vsim2_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vsim2_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vsim2_srclk_mode_sel(0);
                exec_6331_ldo_vsim2_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vsim2_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vsim2_srclk_mode_sel(1);
                exec_6331_ldo_vsim2_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vsim2_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vsim2_srclk_mode_sel(2);
                exec_6331_ldo_vsim2_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vsim2_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vsim2_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vsim2_lp_ctrl(0);
}

void exec_6331_ldo_vfbb_mode_test(void)
{
    pr_notice("no exec_6331_ldo_vfbb_mode_test\n");
}
...
void exec_6331_ldo_vibr_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vibr_mode = %d\n", mt6331_upmu_get_qi_vibr_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vibr_mode = %d\n", mt6331_upmu_get_qi_vibr_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vibr_mode = %d\n", mt6331_upmu_get_qi_vibr_mode());
...
void exec_6331_ldo_vibr_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vibr_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vibr_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vibr_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vibr_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vibr_mode = %d\n", mt6331_upmu_get_qi_vibr_mode());

                pr_notice("mt6331_upmu_set_rg_vibr_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vibr_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vibr_mode = %d\n", mt6331_upmu_get_qi_vibr_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vibr_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vibr_srclk_mode_sel(0);
                exec_6331_ldo_vibr_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vibr_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vibr_srclk_mode_sel(1);
                exec_6331_ldo_vibr_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vibr_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vibr_srclk_mode_sel(2);
                exec_6331_ldo_vibr_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vibr_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vibr_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vibr_lp_ctrl(0);
}

void exec_6331_ldo_vrtc_mode_test(void)
{
    pr_notice("no exec_6331_ldo_vrtc_mode_test\n");
}

void exec_6331_ldo_vdig18_mode_test(void)
{
    pr_notice("no exec_6331_ldo_vdig18_mode_test\n");
}
...
void exec_6331_ldo_vmipi_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vmipi_mode = %d\n", mt6331_upmu_get_qi_vmipi_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vmipi_mode = %d\n", mt6331_upmu_get_qi_vmipi_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vmipi_mode = %d\n", mt6331_upmu_get_qi_vmipi_mode());
...
void exec_6331_ldo_vmipi_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vmipi_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vmipi_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vmipi_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vmipi_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vmipi_mode = %d\n", mt6331_upmu_get_qi_vmipi_mode());

                pr_notice("mt6331_upmu_set_rg_vmipi_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vmipi_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vmipi_mode = %d\n", mt6331_upmu_get_qi_vmipi_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vmipi_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vmipi_srclk_mode_sel(0);
                exec_6331_ldo_vmipi_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vmipi_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vmipi_srclk_mode_sel(1);
                exec_6331_ldo_vmipi_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vmipi_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vmipi_srclk_mode_sel(2);
                exec_6331_ldo_vmipi_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vmipi_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vmipi_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vmipi_lp_ctrl(0);
}
...
void exec_6331_ldo_vcamd_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vcamd_mode = %d\n", mt6331_upmu_get_qi_vcamd_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vcamd_mode = %d\n", mt6331_upmu_get_qi_vcamd_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vcamd_mode = %d\n", mt6331_upmu_get_qi_vcamd_mode());
...
void exec_6331_ldo_vcamd_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vcamd_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vcamd_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vcamd_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vcamd_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vcamd_mode = %d\n", mt6331_upmu_get_qi_vcamd_mode());

                pr_notice("mt6331_upmu_set_rg_vcamd_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vcamd_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vcamd_mode = %d\n", mt6331_upmu_get_qi_vcamd_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vcamd_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vcamd_srclk_mode_sel(0);
                exec_6331_ldo_vcamd_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vcamd_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vcamd_srclk_mode_sel(1);
                exec_6331_ldo_vcamd_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vcamd_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vcamd_srclk_mode_sel(2);
                exec_6331_ldo_vcamd_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vcamd_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vcamd_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vcamd_lp_ctrl(0);
}
...
void exec_6331_ldo_vusb10_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vusb10_mode = %d\n", mt6331_upmu_get_qi_vusb10_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vusb10_mode = %d\n", mt6331_upmu_get_qi_vusb10_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vusb10_mode = %d\n", mt6331_upmu_get_qi_vusb10_mode());
...
void exec_6331_ldo_vusb10_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vusb10_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vusb10_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vusb10_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vusb10_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vusb10_mode = %d\n", mt6331_upmu_get_qi_vusb10_mode());

                pr_notice("mt6331_upmu_set_rg_vusb10_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vusb10_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vusb10_mode = %d\n", mt6331_upmu_get_qi_vusb10_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vusb10_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vusb10_srclk_mode_sel(0);
                exec_6331_ldo_vusb10_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vusb10_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vusb10_srclk_mode_sel(1);
                exec_6331_ldo_vusb10_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vusb10_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vusb10_srclk_mode_sel(2);
                exec_6331_ldo_vusb10_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vusb10_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vusb10_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vusb10_lp_ctrl(0);
}
...
void exec_6331_ldo_vcam_io_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vcam_io_mode = %d\n", mt6331_upmu_get_qi_vcam_io_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vcam_io_mode = %d\n", mt6331_upmu_get_qi_vcam_io_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vcam_io_mode = %d\n", mt6331_upmu_get_qi_vcam_io_mode());
...
void exec_6331_ldo_vcam_io_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vcam_io_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vcam_io_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vcam_io_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vcam_io_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vcam_io_mode = %d\n", mt6331_upmu_get_qi_vcam_io_mode());

                pr_notice("mt6331_upmu_set_rg_vcam_io_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vcam_io_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vcam_io_mode = %d\n", mt6331_upmu_get_qi_vcam_io_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vcam_io_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vcam_io_srclk_mode_sel(0);
                exec_6331_ldo_vcam_io_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vcam_io_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vcam_io_srclk_mode_sel(1);
                exec_6331_ldo_vcam_io_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vcam_io_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vcam_io_srclk_mode_sel(2);
                exec_6331_ldo_vcam_io_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vcam_io_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vcam_io_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vcam_io_lp_ctrl(0);
}
...
void exec_6331_ldo_vsram_dvfs1_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vsram_dvfs1_mode = %d\n", mt6331_upmu_get_qi_vsram_dvfs1_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vsram_dvfs1_mode = %d\n", mt6331_upmu_get_qi_vsram_dvfs1_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vsram_dvfs1_mode = %d\n", mt6331_upmu_get_qi_vsram_dvfs1_mode());
...
void exec_6331_ldo_vsram_dvfs1_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vsram_dvfs1_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vsram_dvfs1_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vsram_dvfs1_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vsram_dvfs1_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vsram_dvfs1_mode = %d\n", mt6331_upmu_get_qi_vsram_dvfs1_mode());

                pr_notice("mt6331_upmu_set_rg_vsram_dvfs1_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vsram_dvfs1_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vsram_dvfs1_mode = %d\n", mt6331_upmu_get_qi_vsram_dvfs1_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vsram_dvfs1_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vsram_dvfs1_srclk_mode_sel(0);
                exec_6331_ldo_vsram_dvfs1_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vsram_dvfs1_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vsram_dvfs1_srclk_mode_sel(1);
                exec_6331_ldo_vsram_dvfs1_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vsram_dvfs1_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vsram_dvfs1_srclk_mode_sel(2);
                exec_6331_ldo_vsram_dvfs1_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vsram_dvfs1_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vsram_dvfs1_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vsram_dvfs1_lp_ctrl(0);
}
...
void exec_6331_ldo_vgp2_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vgp2_mode = %d\n", mt6331_upmu_get_qi_vgp2_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vgp2_mode = %d\n", mt6331_upmu_get_qi_vgp2_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vgp2_mode = %d\n", mt6331_upmu_get_qi_vgp2_mode());
...
void exec_6331_ldo_vgp2_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vgp2_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vgp2_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vgp2_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vgp2_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vgp2_mode = %d\n", mt6331_upmu_get_qi_vgp2_mode());

                pr_notice("mt6331_upmu_set_rg_vgp2_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vgp2_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vgp2_mode = %d\n", mt6331_upmu_get_qi_vgp2_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vgp2_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vgp2_srclk_mode_sel(0);
                exec_6331_ldo_vgp2_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vgp2_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vgp2_srclk_mode_sel(1);
                exec_6331_ldo_vgp2_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vgp2_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vgp2_srclk_mode_sel(2);
                exec_6331_ldo_vgp2_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vgp2_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vgp2_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vgp2_lp_ctrl(0);
}
...
void exec_6331_ldo_vgp3_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vgp3_mode = %d\n", mt6331_upmu_get_qi_vgp3_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vgp3_mode = %d\n", mt6331_upmu_get_qi_vgp3_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vgp3_mode = %d\n", mt6331_upmu_get_qi_vgp3_mode());
...
void exec_6331_ldo_vgp3_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vgp3_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vgp3_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vgp3_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vgp3_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vgp3_mode = %d\n", mt6331_upmu_get_qi_vgp3_mode());

                pr_notice("mt6331_upmu_set_rg_vgp3_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vgp3_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vgp3_mode = %d\n", mt6331_upmu_get_qi_vgp3_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vgp3_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vgp3_srclk_mode_sel(0);
                exec_6331_ldo_vgp3_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vgp3_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vgp3_srclk_mode_sel(1);
                exec_6331_ldo_vgp3_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vgp3_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vgp3_srclk_mode_sel(2);
                exec_6331_ldo_vgp3_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vgp3_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vgp3_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vgp3_lp_ctrl(0);
}
...
void exec_6331_ldo_vbiasn_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vbiasn_mode = %d\n", mt6331_upmu_get_qi_vbiasn_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6331_upmu_get_qi_vbiasn_mode = %d\n", mt6331_upmu_get_qi_vbiasn_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6331_upmu_get_qi_vbiasn_mode = %d\n", mt6331_upmu_get_qi_vbiasn_mode());
...
void exec_6331_ldo_vbiasn_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6331_upmu_set_rg_vbiasn_lp_ctrl] %d\n", i);
        mt6331_upmu_set_rg_vbiasn_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6331_upmu_set_rg_vbiasn_lp_mode_set(0);\n");
                        mt6331_upmu_set_rg_vbiasn_lp_mode_set(0);
                pr_notice("mt6331_upmu_get_qi_vbiasn_mode = %d\n", mt6331_upmu_get_qi_vbiasn_mode());

                pr_notice("mt6331_upmu_set_rg_vbiasn_lp_mode_set(1);\n");
                        mt6331_upmu_set_rg_vbiasn_lp_mode_set(1);
                pr_notice("mt6331_upmu_get_qi_vbiasn_mode = %d\n", mt6331_upmu_get_qi_vbiasn_mode());
                break;

            case 1:
                pr_notice("[mt6331_upmu_set_rg_vbiasn_srclk_mode_sel(0)]\n");
                         mt6331_upmu_set_rg_vbiasn_srclk_mode_sel(0);
                exec_6331_ldo_vbiasn_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vbiasn_srclk_mode_sel(1)]\n");
                         mt6331_upmu_set_rg_vbiasn_srclk_mode_sel(1);
                exec_6331_ldo_vbiasn_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vbiasn_srclk_mode_sel(2)]\n");
                         mt6331_upmu_set_rg_vbiasn_srclk_mode_sel(2);
                exec_6331_ldo_vbiasn_mode_test_sub();

                pr_notice("[mt6331_upmu_set_rg_vbiasn_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6331_upmu_set_rg_vbiasn_lp_ctrl(0);\n"); mt6331_upmu_set_rg_vbiasn_lp_ctrl(0);
}
...
void exec_6332_ldo_vauxb32_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6332_upmu_get_qi_vauxb32_mode = %d\n", mt6332_upmu_get_qi_vauxb32_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6332_upmu_get_qi_vauxb32_mode = %d\n", mt6332_upmu_get_qi_vauxb32_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6332_upmu_get_qi_vauxb32_mode = %d\n", mt6332_upmu_get_qi_vauxb32_mode());
...
void exec_6332_ldo_vauxb32_mode_test(void)
{
    ...
    pr_notice("mt6332_upmu_set_rg_vauxb32_auxadc_pwdb_en(1);\n");
            mt6332_upmu_set_rg_vauxb32_auxadc_pwdb_en(1);

    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_rg_vauxb32_lp_ctrl] %d\n", i);
        mt6332_upmu_set_rg_vauxb32_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6332_upmu_set_rg_vauxb32_lp_mode_set(0);\n");
                        mt6332_upmu_set_rg_vauxb32_lp_mode_set(0);
                pr_notice("mt6332_upmu_get_qi_vauxb32_mode = %d\n", mt6332_upmu_get_qi_vauxb32_mode());

                pr_notice("mt6332_upmu_set_rg_vauxb32_lp_mode_set(1);\n");
                        mt6332_upmu_set_rg_vauxb32_lp_mode_set(1);
                pr_notice("mt6332_upmu_get_qi_vauxb32_mode = %d\n", mt6332_upmu_get_qi_vauxb32_mode());
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_rg_vauxb32_srclk_mode_sel(0)]\n");
                         mt6332_upmu_set_rg_vauxb32_srclk_mode_sel(0);
                exec_6332_ldo_vauxb32_mode_test_sub();

                pr_notice("[mt6332_upmu_set_rg_vauxb32_srclk_mode_sel(1)]\n");
                         mt6332_upmu_set_rg_vauxb32_srclk_mode_sel(1);
                exec_6332_ldo_vauxb32_mode_test_sub();

                pr_notice("[mt6332_upmu_set_rg_vauxb32_srclk_mode_sel(2)]\n");
                         mt6332_upmu_set_rg_vauxb32_srclk_mode_sel(2);
                exec_6332_ldo_vauxb32_mode_test_sub();

                pr_notice("[mt6332_upmu_set_rg_vauxb32_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6332_upmu_set_rg_vauxb32_lp_ctrl(0);\n"); mt6332_upmu_set_rg_vauxb32_lp_ctrl(0);
}
...
void exec_6332_ldo_vbif28_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6332_upmu_get_qi_vbif28_mode = %d\n", mt6332_upmu_get_qi_vbif28_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6332_upmu_get_qi_vbif28_mode = %d\n", mt6332_upmu_get_qi_vbif28_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6332_upmu_get_qi_vbif28_mode = %d\n", mt6332_upmu_get_qi_vbif28_mode());
...
void exec_6332_ldo_vbif28_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_rg_vbif28_lp_ctrl] %d\n", i);
        mt6332_upmu_set_rg_vbif28_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6332_upmu_set_rg_vbif28_lp_mode_set(0);\n");
                        mt6332_upmu_set_rg_vbif28_lp_mode_set(0);
                pr_notice("mt6332_upmu_get_qi_vbif28_mode = %d\n", mt6332_upmu_get_qi_vbif28_mode());

                pr_notice("mt6332_upmu_set_rg_vbif28_lp_mode_set(1);\n");
                        mt6332_upmu_set_rg_vbif28_lp_mode_set(1);
                pr_notice("mt6332_upmu_get_qi_vbif28_mode = %d\n", mt6332_upmu_get_qi_vbif28_mode());
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_rg_vbif28_srclk_mode_sel(0)]\n");
                         mt6332_upmu_set_rg_vbif28_srclk_mode_sel(0);
                exec_6332_ldo_vbif28_mode_test_sub();

                pr_notice("[mt6332_upmu_set_rg_vbif28_srclk_mode_sel(1)]\n");
                         mt6332_upmu_set_rg_vbif28_srclk_mode_sel(1);
                exec_6332_ldo_vbif28_mode_test_sub();

                pr_notice("[mt6332_upmu_set_rg_vbif28_srclk_mode_sel(2)]\n");
                         mt6332_upmu_set_rg_vbif28_srclk_mode_sel(2);
                exec_6332_ldo_vbif28_mode_test_sub();

                pr_notice("[mt6332_upmu_set_rg_vbif28_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6332_upmu_set_rg_vbif28_lp_ctrl(0);\n"); mt6332_upmu_set_rg_vbif28_lp_ctrl(0);
}
...
void exec_6332_ldo_vusb33_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6332_upmu_get_qi_vusb33_mode = %d\n", mt6332_upmu_get_qi_vusb33_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6332_upmu_get_qi_vusb33_mode = %d\n", mt6332_upmu_get_qi_vusb33_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6332_upmu_get_qi_vusb33_mode = %d\n", mt6332_upmu_get_qi_vusb33_mode());
...
void exec_6332_ldo_vusb33_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_rg_vusb33_lp_ctrl] %d\n", i);
        mt6332_upmu_set_rg_vusb33_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6332_upmu_set_rg_vusb33_lp_mode_set(0);\n");
                        mt6332_upmu_set_rg_vusb33_lp_mode_set(0);
                pr_notice("mt6332_upmu_get_qi_vusb33_mode = %d\n", mt6332_upmu_get_qi_vusb33_mode());

                pr_notice("mt6332_upmu_set_rg_vusb33_lp_mode_set(1);\n");
                        mt6332_upmu_set_rg_vusb33_lp_mode_set(1);
                pr_notice("mt6332_upmu_get_qi_vusb33_mode = %d\n", mt6332_upmu_get_qi_vusb33_mode());
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_rg_vusb33_srclk_mode_sel(0)]\n");
                         mt6332_upmu_set_rg_vusb33_srclk_mode_sel(0);
                exec_6332_ldo_vusb33_mode_test_sub();

                pr_notice("[mt6332_upmu_set_rg_vusb33_srclk_mode_sel(1)]\n");
                         mt6332_upmu_set_rg_vusb33_srclk_mode_sel(1);
                exec_6332_ldo_vusb33_mode_test_sub();

                pr_notice("[mt6332_upmu_set_rg_vusb33_srclk_mode_sel(2)]\n");
                         mt6332_upmu_set_rg_vusb33_srclk_mode_sel(2);
                exec_6332_ldo_vusb33_mode_test_sub();

                pr_notice("[mt6332_upmu_set_rg_vusb33_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6332_upmu_set_rg_vusb33_lp_ctrl(0);\n"); mt6332_upmu_set_rg_vusb33_lp_ctrl(0);
}

void exec_6332_ldo_vdig18_mode_test(void)
{
    pr_notice("no exec_6332_ldo_vdig18_mode_test\n");
}
...
void exec_6332_ldo_vsram_dvfs2_mode_test_sub(void)
{
    ...
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(0);\n"); set_srclken_1_val(0); set_srclken_2_val(0);
    pr_notice("mt6332_upmu_get_qi_vsram_dvfs2_mode = %d\n", mt6332_upmu_get_qi_vsram_dvfs2_mode());
    pr_notice("set_srclken_1_val(0); set_srclken_2_val(1);\n"); set_srclken_1_val(0); set_srclken_2_val(1);
    pr_notice("mt6332_upmu_get_qi_vsram_dvfs2_mode = %d\n", mt6332_upmu_get_qi_vsram_dvfs2_mode());
    pr_notice("set_srclken_1_val(1); set_srclken_2_val(0);\n"); set_srclken_1_val(1); set_srclken_2_val(0);
    pr_notice("mt6332_upmu_get_qi_vsram_dvfs2_mode = %d\n", mt6332_upmu_get_qi_vsram_dvfs2_mode());
...
void exec_6332_ldo_vsram_dvfs2_mode_test(void)
{
    ...
    for(i=0;i<=1;i++)
    {
        pr_notice("[mt6332_upmu_set_rg_vsram_dvfs2_lp_ctrl] %d\n", i);
        mt6332_upmu_set_rg_vsram_dvfs2_lp_ctrl(i);

        switch(i){
            case 0:
                pr_notice("mt6332_upmu_set_rg_vsram_dvfs2_lp_mode_set(0);\n");
                        mt6332_upmu_set_rg_vsram_dvfs2_lp_mode_set(0);
                pr_notice("mt6332_upmu_get_qi_vsram_dvfs2_mode = %d\n", mt6332_upmu_get_qi_vsram_dvfs2_mode());

                pr_notice("mt6332_upmu_set_rg_vsram_dvfs2_lp_mode_set(1);\n");
                        mt6332_upmu_set_rg_vsram_dvfs2_lp_mode_set(1);
                pr_notice("mt6332_upmu_get_qi_vsram_dvfs2_mode = %d\n", mt6332_upmu_get_qi_vsram_dvfs2_mode());
                break;

            case 1:
                pr_notice("[mt6332_upmu_set_rg_vsram_dvfs2_srclk_mode_sel(0)]\n");
                         mt6332_upmu_set_rg_vsram_dvfs2_srclk_mode_sel(0);
                exec_6332_ldo_vsram_dvfs2_mode_test_sub();

                pr_notice("[mt6332_upmu_set_rg_vsram_dvfs2_srclk_mode_sel(1)]\n");
                         mt6332_upmu_set_rg_vsram_dvfs2_srclk_mode_sel(1);
                exec_6332_ldo_vsram_dvfs2_mode_test_sub();

                pr_notice("[mt6332_upmu_set_rg_vsram_dvfs2_srclk_mode_sel(2)]\n");
                         mt6332_upmu_set_rg_vsram_dvfs2_srclk_mode_sel(2);
                exec_6332_ldo_vsram_dvfs2_mode_test_sub();

                pr_notice("[mt6332_upmu_set_rg_vsram_dvfs2_srclk_mode_sel(3)]\n");
    ...
    pr_notice("Final reset to 0: mt6332_upmu_set_rg_vsram_dvfs2_lp_ctrl(0);\n"); mt6332_upmu_set_rg_vsram_dvfs2_lp_ctrl(0);
}
#endif
...
void bif_debug(void)
{
    ...
    pr_notice("[bif_debug] qi_bif_tx_en, qi_bif_tx_data, qi_bif_rx_en, qi_bif_rx_data, bif_tx_state, bif_flow_ctl_state, bif_rx_state, bif_data_num, rgs_baton_ht\n");
...
void bif_init(void)
{
    ...
    pr_notice("[bif_init] done. Reg[0x%x]=0x%x, Reg[0x%x]=0x%x, Reg[0x%x]=0x%x, Reg[0x%x]=0x%x\n",
...
void exec_6331_efuse_test(void)
{
    ...
    pr_notice("[exec_6331_efuse_test] start\n");
    ...
    pr_notice("[exec_6331_efuse_test] Done\n");
}
...
void exec_6332_efuse_test(void)
{
    ...
    pr_notice("[exec_6332_efuse_test] start\n");
    ...
    pr_notice("[exec_6332_efuse_test] Done\n");
}
#endif
...
void auxadc_battery_int_protection_6331(U32 test_type, U32 test_mode)
{
    ...
    while (!mt6331_upmu_get_auxadc_adc_rdy_lbat()) {
        mdelay(1000);
        timeout_count++;
        pr_notice("[auxadc_battery_int_protection_6331] wait for lbat ready! timeout_count = (%d)\n", timeout_count);
    ...
    pr_notice("[auxadc_battery_int_protection_6331] setting .. done (adc_out_lbat=%d, lbat_debounce_count_max=%d, lbat_debounce_count_min=%d) \n",
        adc_out_lbat, lbat_debounce_count_max, lbat_debounce_count_min);


    if (test_mode == SLEEP_MODE) {
        pr_notice("[auxadc_battery_int_protection_6331] sleep mode\n");
...
void mt6331_bat_int_close(void)
{
    ...
    pr_notice("[mt6331_bat_int_close] done\n");
}
...
void auxadc_battery_int_protection_6332(U32 test_type, U32 test_mode)
{
    ...
    if (test_mode == SLEEP_MODE) {
        pr_notice("[auxadc_battery_int_protection_6332] sleep mode\n");
        //0.0 wakeup start setting for sleep mode
    ...
    pr_notice("[auxadc_battery_int_protection_6332] E1 workaround\n");
    ...
    while (!mt6332_upmu_get_auxadc_adc_rdy_lbat()) {
        mdelay(1000);
        timeout_count++;
        pr_notice("[auxadc_battery_int_protection_6332] wait for lbat ready! timeout_count = (%d)\n", timeout_count);
        if (timeout_count > 10000) break;
    }
    ...
    //9. Test on VBAT = 3.5 -> 3.4 -> 3.3 and receive interrupt  -- LBAT_TEST
    //9. Test on VBAT = 4.0 -> 4.2 -> 4.3 and receive interrupt  -- HBAT_TEST
    pr_notice("[auxadc_battery_int_protection_6332] setting .. done (adc_out_lbat=%d, lbat_debounce_count_max=%d, lbat_debounce_count_min=%d) \n",
        adc_out_lbat, lbat_debounce_count_max, lbat_debounce_count_min);
    if (test_mode == SLEEP_MODE) {
        pr_notice("[auxadc_battery_int_protection_6332] sleep mode\n");
        //0.0 wakeup start setting for sleep mode
...
void mt6332_bat_int_close(void)
{
    ...
    pr_notice("[mt6332_bat_int_close] done\n");
}
...
void auxadc_thermal_int_protection_6331(U32 test_type, U32 test_mode)
{
    ...
    while (!mt6331_upmu_get_auxadc_adc_rdy_thr_hw()) {
        timeout_count++;
        pr_notice("[auxadc_thermal_int_protection_6331] wait for lbat ready! timeout_count = (%d)\n", timeout_count);
        if (timeout_count > 10000) break;
    }
    ...
    //9. Test on VBAT = 3.5 -> 3.4 -> 3.3 and receive interrupt  -- LBAT_TEST
    //9. Test on VBAT = 4.0 -> 4.2 -> 4.3 and receive interrupt  -- HBAT_TEST
    pr_notice("[auxadc_thermal_int_protection_6331] done (adc_out_thr=%d, thr_debounce_count_max=%d, thr_debounce_count_min=%d) \n",
...
void mt6331_thr_int_close(void){
            ...
            pr_notice("[mt6331_thr_int_close] done\n");
}
...
void auxadc_thermal_int_protection_6332(U32 test_type, U32 test_mode)
{
    ...
    while (!mt6332_upmu_get_auxadc_adc_rdy_thr_hw()) {
        timeout_count++;
        pr_notice("[auxadc_thermal_int_protection_6332] wait for lbat ready! timeout_count = (%d)\n", timeout_count);
        if (timeout_count > 10000) break;
    }
    ...
    pr_notice("[auxadc_thermal_int_protection_6332] done (adc_out_thr=%d, thr_debounce_count_max=%d, thr_debounce_count_min=%d) \n",
        adc_out_thr, thr_debounce_count_max, thr_debounce_count_min);

    if (test_mode == SLEEP_MODE) {
        pr_notice("[auxadc_thermal_int_protection_6332] sleep mode\n");
        //0.0 wakeup start setting for sleep mode
        mt6332_upmu_set_strup_auxadc_start_sel(0);
        mt6332_upmu_set_strup_auxadc_rstb_sw(1);
        mt6332_upmu_set_strup_auxadc_rstb_sel(1);
...
void mt6332_thr_int_close(void)
{
            ...
            pr_notice("[mt6332_thr_int_close] done\n");
}
...
void auxadc_battery_wakeup_measure_6331(U32 test_mode)
{
    ...
    if (test_mode == WAKE_UP_MODE) {
        pr_notice("[auxadc_battery_wakeup_measure_test_6331] WAKEUP mode setting\n");
        //0.0 wakeup start setting for sleep mode
        mt6331_upmu_set_strup_auxadc_start_sel(0);
        mt6331_upmu_set_strup_auxadc_rstb_sw(1);
        mt6331_upmu_set_strup_auxadc_rstb_sel(1);
    ...
    while (!mt6331_upmu_get_auxadc_adc_rdy_wakeup()){
        count++;
        if (count> 100) {
            pr_notice("[auxadc_battery_wakeup_measure_test_6331] WHILE LOOP TIMEOUT!!\n");
            break;
        }
    }
    ...
    if (mt6331_upmu_get_auxadc_adc_rdy_wakeup()){
        ...
        pr_notice("[auxadc_battery_wakeup_measure_test_6331] wakeup_volt = %d\n", wakeup_volt);
    }
...
void auxadc_battery_wakeup_measure_6332(U32 test_mode)
{
    ...
    if (test_mode == WAKE_UP_MODE) {
        pr_notice("[auxadc_battery_wakeup_measure_test_6332] WAKEUP mode setting\n");
        //0.0 wakeup start setting for sleep mode
        mt6332_upmu_set_strup_auxadc_start_sel(0);
        mt6332_upmu_set_strup_auxadc_rstb_sw(1);
        mt6332_upmu_set_strup_auxadc_rstb_sel(1);
    ...
    while (!mt6332_upmu_get_auxadc_adc_rdy_wakeup()){
        count++;
        if (count> 100) {
            pr_notice("[auxadc_battery_wakeup_measure_test_6332] WHILE LOOP TIMEOUT!!\n");
            break;
        }
    }
    ...
    if (mt6332_upmu_get_auxadc_adc_rdy_wakeup()){
        ...
        pr_notice("[auxadc_battery_wakeup_measure_test_6332] wakeup_volt = %d\n", wakeup_volt);
    }
...
void auxadc_swctrl_measure_test_6331(void)
{
    ...
    for (i=0; i< MAX_CHANNEL_NUM; i++) {
        ...
        pr_notice("[auxadc_swctrl_measure_test_6331] adc info: channel_num= %d, chip_num = %d\n", channel_num[i], chip_num[i]);
        if (chip_num[i] == MT6331_CHIP) {
            ...
            pr_notice("[auxadc_swctrl_measure_test_6331] adc_result = %d\n", adc_output);
        }
    }
}
...
void auxadc_swctrl_measure_test_6332(void)
{
    ...
    for (i=0; i< MAX_CHANNEL_NUM; i++) {
        ...
        chip_num[i] = PMIC_IMM_GetChipNumber(eChannelEnumList[i]);
        //user_num[i] = PMIC_IMM_GetUserNumber(eChannelEnumList[i]);
        pr_notice("[auxadc_swctrl_measure_test_6332] adc info: channel_num= %d, chip_num = %d\n", channel_num[i], chip_num[i]);
        if (chip_num[i] == MT6332_CHIP || chip_num[i] == 2) {
            ...
            pr_notice("[auxadc_swctrl_measure_test_6332] adc_result = %d\n", adc_output);
        }
    }
}
