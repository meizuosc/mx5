...
//#define FPC_IRQF_TRIGGER_HIGH_USED
/* -------------------------------------------------------------------- */
...
extern void fpc1020_irq_disable(fpc1020_data_t *fpc1020);

extern void fpc1020_irq_enable(fpc1020_data_t *fpc1020);
