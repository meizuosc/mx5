/*
 * m85_fingerprint.c - fingerprint driver  for m85 board
 *
...
struct mt_chip_conf spi0_ctrdata[] = {
	...
	.setuptime = 60,
	.holdtime = 60,
	.high_time = 25, //15--3m   25--2m   50--1m  [ 100--0.5m]
	.low_time = 25,
	.cs_idletime = 8,
	.ulthgh_thrsh = 0,
...
static struct spi_board_info spi_fp_board_info[] __initdata= {
	[0] = {
		...
		.platform_data		= NULL,
		.bus_num		= 0,
	#if defined(CONFIG_FINGERPRINT_FPC1150)
		.controller_data	= &spi0_ctrdata[2],
	#elif defined(CONFIG_FINGERPRINT_GF616)
		.controller_data	= &spi0_ctrdata[1],
	#else
		.controller_data	= &spi0_ctrdata[0],
	#endif
	},
};
#endif
...
*/
static void __init m85_fingerprint_init_gpio(void)
{
#if 1
	/*set spi gpio*/	
...
*
*/
static int __init m85_init_fingerprint(void)
{	
	printk("%s(): ++++\n", __func__);

	//return 0;
	
	m85_fingerprint_init_gpio();
...
arch_initcall(m85_init_fingerprint);

MODULE_DESCRIPTION("m85 fingerprint driver");
MODULE_AUTHOR("");
