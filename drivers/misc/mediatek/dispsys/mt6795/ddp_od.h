...
///===============================================================================
    ...
    #define RG_WR_PRE_HIGH                REG_FLD(6, 6)
    #define RG_WRULTRA_EN          		  REG_FLD(1,12)
	#define RG_WR_LOW          			  REG_FLD(6,16)
	#define RG_WR_PRELOW          		  REG_FLD(6,22)
#else	
	...
	#define RG_RD_PRE_HIGH				  REG_FLD(6, 6)
	#define RG_RDULTRA_EN				  REG_FLD(1,12)
	#define RG_RD_LOW					  REG_FLD(6,16)
	#define RG_RD_PRELOW				  REG_FLD(6,22)
#else	
    ...
    #define PKT_CRC_EN                    REG_FLD(1,28)//[28:28]
