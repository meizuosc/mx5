...
#define DCM_TAG     "[DCM] "
#define dcm_emerg(fmt, args...)	    pr_emerg(DCM_TAG fmt, ##args)
#define dcm_alert(fmt, args...)	    pr_alert(DCM_TAG fmt, ##args)
#define dcm_crit(fmt, args...)		pr_crit(DCM_TAG fmt, ##args)
#define dcm_err(fmt, args...)		pr_err(DCM_TAG fmt, ##args)
#define dcm_warn(fmt, args...)		pr_warn(DCM_TAG fmt, ##args)
#define dcm_notice(fmt, args...)	pr_notice(DCM_TAG fmt, ##args)
#define dcm_info(fmt, args...)		pr_info(DCM_TAG fmt, ##args)
#define dcm_debug(fmt, args...)	    pr_info(DCM_TAG fmt, ##args)
