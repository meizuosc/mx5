 ...
 */
#define DEF_CPU_UP_THRESHOLD                (85)
#define DEF_CPU_UP_TIMES                    (2)
#define DEF_CPU_DOWN_THRESHOLD              (70)

#define DEF_CPU_DOWN_TIMES                  (2)
 ...
 */
#define DEF_ES_CPU_UP_THRESHOLD             (90)
#define DEF_ES_CPU_UP_TIMES                 (2)
#define DEF_ES_CPU_DOWN_THRESHOLD           (80)
