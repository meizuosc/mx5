...
#include "ov5670ofilmmipi_Sensor_ma01.h"
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = MA01_OV5670OFILMMIPI_SENSOR_ID & 0x0FFF0,		//record sensor id defined in Kd_imgsensor.h
...
static int ofilm_read_otp(ofilm_otp_struct *pOtp)
{
			...
			*sensor_id = ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C));
			if (*sensor_id == imgsensor_info.sensor_id) {				
				...
				LOG_INF("i2c write id: 0x%x, sensor id: 0x%x, module_id:0x%x.\n",
					...
					*sensor_id = MA01_OV5670OFILMMIPI_SENSOR_ID;
					front_cam_id = MA01_OV5670OFILMMIPI_SENSOR_ID;
					return ERROR_NONE;
				}
				else 
...
UINT32 MA01_OV5670_OFILM_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	MA01_OV5670_OFILM_MIPI_RAW_SensorInit	*/
