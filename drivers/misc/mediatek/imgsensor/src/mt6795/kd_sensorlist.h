...
#endif
#if defined(IMX220_LITEON_MIPI_RAW)
    {IMX220_LITEON_SENSOR_ID, SENSOR_DRVNAME_IMX220_LITEON_MIPI_RAW, IMX220_LITEON_MIPI_RAW_SensorInit},
#endif
...
#endif
#if defined(OV13853_SUNNY_MIPI_RAW)
    {OV13853_SUNNY_SENSOR_ID, SENSOR_DRVNAME_OV13853_SUNNY_MIPI_RAW,OV13853_SUNNY_MIPI_RAW_SensorInit},
#endif
#if defined(OV13853_OFILM_MIPI_RAW)
    {OV13853_OFILM_SENSOR_ID, SENSOR_DRVNAME_OV13853_OFILM_MIPI_RAW,OV13853_OFILM_MIPI_RAW_SensorInit},
#endif
...
#endif
#if defined(OV5670_MIPI_RAW_MA01)
    {MA01_OV5670MIPI_SENSOR_ID, SENSOR_DRVNAME_MA01_OV5670_MIPI_RAW, MA01_OV5670_MIPI_RAW_SensorInit},
#endif
#if defined(OV5670_OFILM_MIPI_RAW_MA01)
    {MA01_OV5670OFILMMIPI_SENSOR_ID, SENSOR_DRVNAME_MA01_OV5670_OFILM_MIPI_RAW, MA01_OV5670_OFILM_MIPI_RAW_SensorInit},
#endif
#if defined(OV5670_SUNNY_MIPI_RAW)
    {OV5670SUNNYMIPI_SENSOR_ID, SENSOR_DRVNAME_OV5670_SUNNY_MIPI_RAW, OV5670_SUNNY_MIPI_RAW_SensorInit},
#endif
...
#endif
#if defined(S5K3L8_SUNNY_MIPI_RAW)
    {S5K3L8_SUNNY_SENSOR_ID, SENSOR_DRVNAME_S5K3L8_SUNNY_MIPI_RAW, S5K3L8_SUNNY_MIPI_RAW_SensorInit},
#endif
#if defined(S5K3L8_OFILM_MIPI_RAW)
    {S5K3L8_OFILM_SENSOR_ID, SENSOR_DRVNAME_S5K3L8_OFILM_MIPI_RAW, S5K3L8_OFILM_MIPI_RAW_SensorInit},
#endif
