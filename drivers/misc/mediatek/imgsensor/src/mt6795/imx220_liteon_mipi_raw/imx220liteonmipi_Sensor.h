 ...
 *
 ****************************************************************************/
#ifndef _IMX220LITEONMIPI_SENSOR_H
#define _IMX220LITEONMIPI_SENSOR_H
...
typedef struct imgsensor_info_struct {
	...
	imgsensor_mode_struct pre1;		//preview scenario relative information
	...
	imgsensor_mode_struct hd_gis_video;//1080P gis video  scenario relative information
	...
	kal_uint8  hd_gis_video_delay_frame;	//enter 1080P gis video delay frame num
	kal_uint8  hs_video_delay_frame;	//enter high speed video  delay frame num
	kal_uint8  slim_video_delay_frame;	//enter slim video delay frame num
	kal_uint8  zsd_delay_frame;		//enter zsd delay frame num
	kal_uint8  hd_4k_video_delay_frame;		//enter hd_4k_video delay frame num
	kal_uint8  slim_cap_delay_frame;		//enter slim_cap delay frame num
