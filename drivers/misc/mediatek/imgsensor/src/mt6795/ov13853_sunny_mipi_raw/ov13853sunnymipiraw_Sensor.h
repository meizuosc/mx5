 ...
 *
 ****************************************************************************/
#ifndef _OV13853SUNNYMIPIRAW_SENSOR_H
#define _OV13853SUNNYMIPIRAW_SENSOR_H
...
typedef struct imgsensor_struct {
    ...
    kal_uint16 orientation;                //sensor orientation info
    ...
    kal_uint32 last_frame_length;        //last framelength
...
extern bool read_sunny_otp_pdaf_data( kal_uint16 addr, BYTE* data, kal_uint32 size);
