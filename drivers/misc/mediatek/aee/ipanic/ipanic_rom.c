...
#ifdef CONFIG_MZ_M85
extern void dump_battery_status(void);
#endif
extern int rstlog_data_to_sd(int dt, void *data);
extern int rstlog_header_to_sd(struct ipanic_data_header *header);
extern void rstlog_panic_begin();
extern void rstlog_panic_end();
extern void sw_rstinfo_dump_type(int type);
