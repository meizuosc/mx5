...
typedef enum CMDQ_SCENARIO_ENUM {
	...
	CMDQ_SCENARIO_DISP_PRIMARY_DISABLE_SECURE_PATH = 27,
	CMDQ_SCENARIO_DISP_SUB_DISABLE_SECURE_PATH = 28,
	CMDQ_SCENARIO_SECURE_NOTIFY_LOOP = 29, /* notifiy there are some tasks exec done in secure path*/
