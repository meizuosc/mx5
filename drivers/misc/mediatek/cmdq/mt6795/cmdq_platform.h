...
typedef enum CMDQ_EVENT_BACKUP_ENUM {
	CMDQ_EVENT_BACKUP_SYNC_TOKEN_VENC_EOF = 0,
	CMDQ_EVENT_BACKUP_SYNC_TOKEN_VENC_INPUT_READY,
	CMDQ_EVENT_BACKUP_COUNT,
} CMDQ_EVENT_BACKUP_ENUM;
