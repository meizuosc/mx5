...
void usb20_pll_settings(bool host, bool forceOn)
{
	if (host) {
		if (forceOn) {	
		   ...
		   #ifdef CONFIG_MZ_M85
		     /*host mode */
	         U3PhyWriteField32(U3D_USBPHYACR1, E60802_RG_USB20_VRT_VREF_SEL_OFST, E60802_RG_USB20_VRT_VREF_SEL, 1); 
			...
			#ifdef CONFIG_MZ_M85
			 /*switch to device mode,set to default value */
	         U3PhyWriteField32(U3D_USBPHYACR1, E60802_RG_USB20_VRT_VREF_SEL_OFST, E60802_RG_USB20_VRT_VREF_SEL, 4); 
	         U3PhyWriteField32(U3D_USBPHYACR1, E60802_RG_USB20_TERM_VREF_SEL_OFST, E60802_RG_USB20_TERM_VREF_SEL, 4);
	        #endif
