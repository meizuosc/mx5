...
#define MEIZU_MARGIN_LEFT	0xCE
#define MEIZU_MARGIN_RIGHT	0xCF
#define MEIZU_MARGIN_UP		0xE2
#define MEIZU_MARGIN_DOWN	0xE3
...
/*apgrade*/
#define TPD_AUTO_UPGRADE	1			// if need upgrade CTP FW when POWER ON,pls enable this MACRO
//#define TPD_HW_REST
