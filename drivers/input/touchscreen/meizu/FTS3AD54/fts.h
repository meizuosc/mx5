 ...
 */
struct fts_ts_info {
        struct cdev              main_cdev ;   	//add
	struct class *           main_class ;	//add
        struct device            *dev;
	...
	//define for using poll mode
        struct hrtimer timer;

	// add for DMA
	unsigned char * pDMARBuf ;
	unsigned char * vDMARBuf ;
	unsigned char * pDMAWBuf ;
	unsigned char * vDMAWBuf ;
	int touch_debug ;
	...
	//struct notifier_block cover_notifier;		//remove the notifier
