...
#define MAX_CHARGING_TIME                   8*60*60	/* 24hr */
...
#else
#define BAT_TASK_PERIOD                      30/* 10sec */
#endif
...
extern void mtk_ta_detector(void);
extern int ta_v_chr_org;
extern kal_bool fast_charger_detect;
extern kal_bool battery_soc_less_30;
#endif
...
#if defined(CONFIG_MTK_SMART_BATTERY) || defined(CONFIG_MZ_SMART_BATTERY)
extern void wake_up_bat(void);
extern void wake_up_bat2(void);
extern void wake_up_bat3(void);
extern void bat_thread_wakeup(void);
...
extern bool force_ico;
extern bool usb_error_check;

extern int cmd_discharging;
extern int mtkts_AP_get_hw_temp(void);

extern struct wake_lock battery_suspend_lock;
extern void set_bat_thread_priority(int pri_val);

#ifdef CONFIG_MZ_M85
extern struct completion completion_dwork;
#endif

#ifdef CONFIG_MZ_MA01
extern int adapter_detect_count;
extern kal_bool vindpm_status;
#endif
