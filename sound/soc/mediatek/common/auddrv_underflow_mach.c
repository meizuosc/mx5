...
void Auddrv_CheckInterruptTiming(void)
{
    ...
    else
    {
        ...
        {
            printk("CheckInterruptTiming  Irq_time_t2 = %llu Irq_time_t1 = %llu Irq_time_t1 - Irq_time_t2 = %llu DL1_Interrupt_Interval_Limit = %d\n",
            ...
            {
                printk("CheckInterruptTiming interrupt may be blocked Irq_time_t2 = %llu mDL1_Interrupt_Interval_Limit = %d\n",
...
void RefineInterrruptInterval(void)
{
    ...
    printk("%s mDL1InterruptInterval = %d mDL1_Interrupt_Interval_Limit = %d\n",__func__,mDL1InterruptInterval,mDL1_Interrupt_Interval_Limit);
}
