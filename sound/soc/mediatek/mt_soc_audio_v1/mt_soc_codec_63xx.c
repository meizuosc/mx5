...
static struct snd_soc_dai_driver mtk_6331_dai_codecs[] =
{
    ...
    },
    {
        ...
        .ops = &mt6323_aif1_dai_ops,
        .playback = {
#if 1 // { huhb@BSP.Audio: Fix "Failed to create XXXX debugfs file" error
...
static bool AudioPreAmp1_Sel(int Mul_Sel)
{
    ...
    {
        OpenMicbias1(false); // turn off headset mic bias to avoid popo noise
...
{
#if 0 //{ huhb@BSP.Audio Fix error route path, no need to this route On M85
...
#if 0 // { huhb@BSP.Audio: no need to call these function
