...
static struct snd_soc_dai_link mt_soc_dai_common[] =
{
    ...
    {
        .name = "VOIP_CALL_BT_SPEAKER_PLAYBACK",
        .stream_name = MT_SOC_VOIP_BT_AND_SPEAKER_OUT_STREAM_NAME,
        .cpu_dai_name   = MT_SOC_VOIP_CALL_BT_AND_SPEAKER_OUT_NAME,
        .platform_name  = MT_SOC_VOIP_BT_AND_SPEAKER_OUT,
        .codec_dai_name = MT_SOC_CODEC_VOIPCALLBTANDSPEAKEROUTDAI_NAME,
        .codec_name = MT_SOC_CODEC_DUMMY_NAME,
        .init = mt_soc_audio_init,
        .ops = &mt_machine_audio_ops,
    },
