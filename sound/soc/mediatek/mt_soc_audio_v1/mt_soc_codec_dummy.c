...
static struct snd_soc_dai_driver dummy_6323_dai_codecs[] =
{
    ...
    {
        .name = MT_SOC_CODEC_VOIPCALLBTANDSPEAKEROUTDAI_NAME,
        .playback = {
            .stream_name = MT_SOC_VOIP_BT_AND_SPEAKER_OUT_STREAM_NAME,
            .channels_min = 1,
            .channels_max = 2,
            .rates = SNDRV_PCM_RATE_8000_48000,
            .formats = SND_SOC_ADV_MT_FMTS,
    ...
    },
    {
        ...
        .playback = {
            .stream_name = MT_SOC_ADC2ADCI2S2_STREAM_NAME" RX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = SND_SOC_ADV_MT_FMTS,
        ...
        .capture = {
            .stream_name = MT_SOC_ADC2ADCI2S2_STREAM_NAME" TX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = SND_SOC_ADV_MT_FMTS,
...

    {
        ...
        .playback = {
            .stream_name = MT_SOC_IO2AWB_STREAM_NAME" RX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = (SNDRV_PCM_FMTBIT_U8 | SNDRV_PCM_FMTBIT_S8 |
        ...
        .capture = {
            .stream_name = MT_SOC_IO2AWB_STREAM_NAME" TX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = (SNDRV_PCM_FMTBIT_U8 | SNDRV_PCM_FMTBIT_S8 |
